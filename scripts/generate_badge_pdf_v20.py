#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v20 PDF — The Navigator Protocol"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/pdf/LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v20.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v20.md"
...
NAVIGATOR = colors.HexColor("#224466")
...
def header_footer(canvas, doc):
    ...
    canvas.drawString(0.45*inch, h - 0.22*inch,
                      "LOT SYSTEMS — BADGES & ACHIEVEMENTS CODEX v20 — THE NAVIGATOR PROTOCOL")
...
def main():
    ...
    doc = SimpleDocTemplate(OUTPUT_PATH, pagesize=letter,
        ...
        title="LOT Badges & Achievements Master Codex v20 — The Navigator Protocol",
    ...
    story.append(Spacer(1, 0.08*inch))
    story.append(Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX — v20", styles['subtitle']))
    story.append(Paragraph("v20 — THE NAVIGATOR PROTOCOL  ·  June 2026", styles['subtitle']))
    story.append(Spacer(1, 0.06*inch))
    story.append(Paragraph("424 BADGES ACROSS 55 CATEGORIES · 394 hidden · 30 visible", styles['meta']))
    ...
    story.append(HRFlowable(width="100%", thickness=1, color=NAVIGATOR,
...
║   ▲·▲   HEADING CONFIRMED   ▦·▦  CHART UPDATED                   ║
║   ···→  DRIFT DETECTED      ◎·N  COMPASS ONLINE                  ║
║                                                                  ║
║  v19 → v20: +35 badges  (389 → 424 total)                        ║
║  Word Turn v11   — THE NAVIGATOR   (drift/vector/bearing…)       ║
║  Time EE v11     — NAVIGATOR HOURS (13:13/05:12/18:42/10:01)     ║
║  Calendar EE v10 — NAVIGATION DAYS (Aug 25/Oct 12/Feb 29)        ║
║  Behavioral v10  — NAVIGATOR STATES (compass_rose/dead_reckoning)║
║  Achievement v8  — NAVIGATOR CLASS (first_fix/atlas_complete…)   ║
║  Mastery v10     — CARTOGRAPHER    (cartographer/long_voyage…)   ║
║  Secret Boss v10 — TERRA INCOGNITA (dead_reckoning/true_north…)  ║
║                                                                  ║
