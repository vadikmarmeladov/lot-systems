#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v19 PDF — The Operator's Grimoire"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/pdf/LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v19.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v19.md"
...
GRIMOIRE = colors.HexColor("#5533aa")
...
def header_footer(canvas, doc):
    ...
    canvas.drawString(0.45*inch, h - 0.22*inch,
                      "LOT SYSTEMS — BADGES & ACHIEVEMENTS CODEX v19 — THE OPERATOR'S GRIMOIRE")
...
def main():
    ...
    doc = SimpleDocTemplate(OUTPUT_PATH, pagesize=letter,
        ...
        title="LOT Badges & Achievements Master Codex v19 — The Operator's Grimoire",
    ...
    story.append(Spacer(1, 0.08*inch))
    story.append(Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX — v19", styles['subtitle']))
    story.append(Paragraph("THE OPERATOR'S GRIMOIRE  ·  June 2026", styles['subtitle']))
    story.append(Spacer(1, 0.06*inch))
    story.append(Paragraph("389 badges · 55 categories · 361 hidden · 28 visible", styles['meta']))
...
║         BADGES & ACHIEVEMENTS MASTER CODEX — v19                 ║
║    RPG · ARCADE · SELF-CARE · SCI-FI · COMPUTER · BOOK          ║
║                                                                  ║
║         > THE OPERATOR'S GRIMOIRE <                              ║
║         [ THE GRIMOIRE OPENS ]                                   ║
║                                                                  ║
║   ∗·∗  SPELL CAST      ▒·░  GRIMOIRE OPEN                        ║
║   ◉→◉  INVOKED         ≈·◈  ARCANE ENTRY                         ║
║   ∗—∗  SIGIL DRAWN     ∿·∿  MANA CHECK                           ║
║                                                                  ║
║  v18 → v19: +35 badges  (354 → 389 total)                        ║
║  Word Turn v10   — THE SPELL BOOK  (spell/cast/invoke/arcane…)  ║
║  Time EE v10     — ARCANE HOURS    (06:06/12:21/21:00/23:23)    ║
║  Calendar EE v9  — SCI-FI LITERARY (Turing/Moon/Sputnik)        ║
║  Behavioral v9   — SPELLBOUND      (dawn_twin/year_first/echo)  ║
║  Achievement v7  — CASTER CLASS    (spell_caster/ten_tongues…)  ║
║  Mastery v9      — ARCANE VAULT    (sigil_keeper/word_archmage) ║
║  Secret Boss v9  — SPELLBOUND      (archmage/dual_founding/…)   ║
║                                                                  ║
║  THE GRIMOIRE NEVER CLOSES. LOG ENTRY = INCANTATION.            ║
╚══════════════════════════════════════════════════════════════════╝"""
