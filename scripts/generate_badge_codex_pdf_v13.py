...
Badge & Achievements Master Codex v13 — PDF Generator
Generates a monospaced terminal-style PDF from the v13 Codex markdown.
...
MINT_COLOR = colors.HexColor('#88eeaa')   # new / v13
...
OUTPUT_PATH = os.path.join(
    BASE_DIR, 'docs', 'badges',
    'LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v13.pdf'
)

MD_PATH = os.path.join(
    BASE_DIR, 'docs', 'badges',
    'LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v13.md'
)
...
def build_pdf():
    ...
    doc = SimpleDocTemplate(
        ...
        title='LOT Badges & Achievements Master Codex v13',
        author='Vadik Marmeladov -- LOT Systems Corporation',
        subject='RPG Arcade Self-Care Badge System v13',
        keywords='LOT badges achievements RPG arcade self-care v13',
    )
    ...
    def on_page(canvas, doc):
        ...
        footer = (
            ...
            f'Badges & Achievements Master Codex v13  *  '
            f'178 badges  *  (c) 2025-2026  *  brand.lot-systems.com  *  '
            f'Page {doc.page}'
        )
