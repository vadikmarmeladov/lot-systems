#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v18 PDF — The Arcade Protocol"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/pdf/LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v18.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v18.md"
...
def header_footer(canvas, doc):
    ...
    canvas.drawString(0.45*inch, h - 0.22*inch,
                      "LOT SYSTEMS — BADGES & ACHIEVEMENTS CODEX v18 — THE ARCADE PROTOCOL")
...
def main():
    ...
    doc = SimpleDocTemplate(OUTPUT_PATH, pagesize=letter,
        ...
        title="LOT Badges & Achievements Master Codex v18 — The Arcade Protocol",
    ...
    story.append(Spacer(1, 0.08*inch))
    story.append(Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX — v18", styles['subtitle']))
    story.append(Paragraph("THE ARCADE PROTOCOL  ·  June 2026", styles['subtitle']))
    story.append(Spacer(1, 0.06*inch))
    story.append(Paragraph("354 badges · 47 categories · 326 hidden · 28 visible", styles['meta']))
    story.append(Paragraph('"Insert coin. Select player. The self is the cartridge. Care is the game."', styles['meta']))
...
║         BADGES & ACHIEVEMENTS MASTER CODEX — v18                 ║
║    RPG · ARCADE · SELF-CARE · SCI-FI · COMPUTER · BOOK          ║
║                                                                  ║
║         > THE ARCADE PROTOCOL <                                  ║
║         [ INSERT COIN TO CONTINUE ]                              ║
║                                                                  ║
║   ○→◉  COIN DROPPED      ↑↑↓↓  CHEAT CONFIRMED                  ║
║   ▓→∞  SCORE LOGGED      ◉·↑   1UP EARNED                       ║
║   →·→  CONTINUE SELECT   ✦◉✦   BIRTHDAY PERFECT                 ║
║                                                                  ║
║  v17 → v18: +35 badges  (319 → 354 total)                       ║
║  Word Turn v9    — ARCADE CABINET   (coin/pixel/sprite/score…)  ║
║  Time EE v9      — POWER-UP HOURS   (07:00/15:15/19:19/04:44)  ║
║  Calendar EE v8  — GAME ANNIVERSARIES (Jan 1/Sept 9/Dec 25)    ║
║  Behavioral EE v8— ARCADE PATTERNS  (birthday/hi-score/1up)    ║
║  Achievement v6  — ARCADE CLASS     (quarter_drop/champion/…)  ║
║  Mastery v8      — HALL OF FAME     (initials/credit/cosmic)    ║
║  Secret Boss v8  — ARCADE FINAL BOSS (player_one/perfect/1up)  ║
║                                                                  ║
║  PLAYER 1 — PRESS START — THE CABINET IS ALWAYS ON.             ║
╚══════════════════════════════════════════════════════════════════╝"""
