#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v35 PDF — The Time Loop"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v35.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v35.md"
...
LOOP_DEEP   = colors.HexColor("#1a2a4a")   # time loop midnight blue
LOOP_AMBER  = colors.HexColor("#8a5200")   # run-timer amber
LOOP_GRID   = colors.HexColor("#f0f4f8")   # light terminal background
...
def build_styles():
    ...
    h2 = ParagraphStyle('LotH2', fontName='Courier-Bold', fontSize=10,
        leading=13, textColor=LOOP_DEEP, spaceBefore=10, spaceAfter=3)
    h3 = ParagraphStyle('LotH3', fontName='Courier-Bold', fontSize=9,
        leading=12, textColor=LOOP_AMBER, spaceBefore=7, spaceAfter=2)
...
def build_pdf():
    ...
    story += [
        ...
        Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX v35 — THE TIME LOOP", styles['meta']),
        Paragraph("905 BADGES · WORD TURN v25 · AUGUST 2026", styles['meta']),
