#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v31 PDF — The Cyberspace Codex"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v31.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v31.md"
...
CYBER       = colors.HexColor("#0a1a2a")   # deep cyber navy — Cyberspace Codex theme
CYBER_GRID  = colors.HexColor("#e8f0f8")   # grid background tint
...
def build_pdf():
    ...
    story += [
        ...
        Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX v31 — THE CYBERSPACE CODEX", styles['meta']),
        Paragraph("781 BADGES · WORD TURN v21 · AUGUST 2026", styles['meta']),
