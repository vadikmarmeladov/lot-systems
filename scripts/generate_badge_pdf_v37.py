#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v37 PDF — The Time Machine"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v37.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v37.md"
...
TIME_DARK   = colors.HexColor("#0a0a1a")   # deep temporal dark
TIME_GRID   = colors.HexColor("#f0f4f8")   # blueprint tint
...
def add_header_footer(canvas, doc):
    ...
    canvas.drawString(0.5 * inch, 0.35 * inch,
        'LOT SYSTEMS — BADGE & ACHIEVEMENT MASTER CODEX v37 — THE TIME MACHINE')
