#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v34 PDF — The Simulation"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v34.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v34.md"
...
SIM_BLUE    = colors.HexColor("#1a3a5c")   # simulation deep blue
SIM_TEAL    = colors.HexColor("#0d6e6e")   # matrix teal
SIM_GRID    = colors.HexColor("#eef4f8")   # light grid background
...
def build_styles():
    ...
    h2 = ParagraphStyle('LotH2', fontName='Courier-Bold', fontSize=10,
        leading=13, textColor=SIM_BLUE, spaceBefore=10, spaceAfter=3)
    h3 = ParagraphStyle('LotH3', fontName='Courier-Bold', fontSize=9,
        leading=12, textColor=SIM_TEAL, spaceBefore=7, spaceAfter=2)
...
def build_pdf():
    ...
    story += [
        ...
        Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX v34 — THE SIMULATION", styles['meta']),
        Paragraph("874 BADGES · WORD TURN v24 · AUGUST 2026", styles['meta']),
