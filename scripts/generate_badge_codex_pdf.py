...
Badge & Achievements Master Codex — PDF Generator
Generates a monospaced terminal-style PDF from the v12 Codex markdown.
"""
...
DIM_COLOR  = colors.HexColor('#666666')  # comments / html tags
...
OUTPUT_PATH = os.path.join(
    ...
    'docs', 'badges',
    'LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v12.pdf'
)
...
def parse_md_to_flowables(md_text, styles):
    ...
    def flush_code():
        if code_block:
            raw = '\n'.join(code_block)
            # Use Preformatted for monospaced code blocks
            pre = Preformatted(
                raw,
    ...
    while i < len(lines):
        ...
        if stripped.startswith('#### '):
            ...
            # Metadata lines (Author/Copyright)
...
def build_pdf():
    ...
    def on_page(canvas, doc):
        ...
        footer = (
            ...
            f'Badges & Achievements Master Codex v12  ·  '
