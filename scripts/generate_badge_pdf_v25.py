#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v25 PDF — The Alchemist"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v25.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v25.md"
...
ALCHEMIST = colors.HexColor("#4a2a08")   # deep amber — alchemist theme
...
def header_footer(canvas, doc):
    ...
    canvas.drawString(0.45 * inch, h - 0.22 * inch,
                      "LOT SYSTEMS — BADGES & ACHIEVEMENTS CODEX v25 — THE ALCHEMIST")
...
def main():
    ...
    doc = SimpleDocTemplate(OUTPUT_PATH, pagesize=letter,
        ...
        title="LOT Badges & Achievements Master Codex v25 — The Alchemist",
        author="Vadik Marmeladov — LOT Systems",
        subject="RPG & Arcade of Self-Care — The Alchemist Edition")
    styles = build_styles()
    story = []
    ...
    story.append(Spacer(1, 0.08 * inch))
    story.append(Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX — v25",
                            styles['subtitle']))
    story.append(Paragraph("THE ALCHEMIST  ·  July 2026", styles['subtitle']))
    story.append(Spacer(1, 0.06 * inch))
    story.append(Paragraph(
        "595 badges · 31 new · Transmute the ordinary into the extraordinary.",
        styles['meta']))
    story.append(Paragraph(
        '"You are the crucible. The work is the transmutation. The record is the philosopher\'s stone."',
        styles['meta']))
...
|         [ GREAT WORK: BEGUN ]                                    |
|                                                                  |
|  .:->  TRANSMUTATION EVENT      =.=   CRUCIBLE FORGED            |
|  o.+o  DISTILLATION COMPLETE    o->   CATALYST DETECTED          |
|  -o-   ALLOY FORMED             o+~   SUBLIMATION SIGNAL         |
|  O..   PRIMA MATERIA WORD       ~.~   MAGNUM OPUS                |
|  o~o   ELIXIR FOUND             o->O  CHRYSALIS STATE            |
|  =.=   REFINEMENT ACTIVE        -#-   ANNEALED                   |
|                                                                  |
|  v24 -> v25: +31 badges  (564 -> 595 total)                      |
|  Word Turn v12  -- THE ALCHEMIST (transmute/crucible/elixir/...) |
|  Calendar v12   -- LITERARY ARCHIVE  (Apr 23 / Sep 23 / Jul 20) |
|  Behavioral v12 -- ALCHEMIST PATTERNS (session/sequence/night)  |
|  Achievement v13-- ALCHEMIST CLASS   (entry/class/complete/...) |
