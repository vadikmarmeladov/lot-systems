#!/usr/bin/env python3
"""Generate LOT Badges & Achievements Master Codex v30 PDF — The Codex Reader"""
...
OUTPUT_PATH = "/home/user/LOT-Computer/docs/badges/LOT-BADGES-ACHIEVEMENTS-MASTER-CODEX-v30.pdf"
MD_PATH = "/home/user/LOT-Computer/docs/badges/LOT_BADGES_ACHIEVEMENTS_MASTER_CODEX_v30.md"
...
LIT        = colors.HexColor("#1a1a3a")   # deep library indigo — Codex Reader theme
...
def build_pdf():
    ...
    story += [
        ...
        Paragraph("BADGES &amp; ACHIEVEMENTS MASTER CODEX v30 — THE CODEX READER", styles['meta']),
        Paragraph("750 BADGES · WORD TURN v20 · AUGUST 2026", styles['meta']),
