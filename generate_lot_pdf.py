...
contents = [
    ...
    ("2", "Milestone Badges",                "Core 3-Tier Progression  ∘ → ≈ → ≋"),
...
pdf.panel([
    "WATER THEME              ∘  -->  ≈  -->  ≋",
    "  ∘  Droplet   Day 7    First drops form. Presence establishing.",
...
pdf.panel([
    "Water symbol   :  ∘    (U+2218 Ring Operator)",
    "Arch  symbol   :  |--  (Box Drawing characters)",
    "Water name     :  Droplet",
    "Arch  name     :  Foundation",
    "Water unlock   :  -> First drops form [∘]",
...
pdf.panel([
    "Water symbol   :  ≈    (U+2248 Almost Equal To / Double Wave)",
    "Arch  symbol   :  |=|  (Box Drawing characters)",
    "Water name     :  Wave",
    "Arch  name     :  Structure",
...
pdf.panel([
    "Water symbol   :  ≋    (U+224B Triple Tilde / Deep Wave)",
    "Arch  symbol   :  ||.||  (Box Drawing characters)",
    "Water name     :  Current",
...
seasonal = [
    ...
    ("[◐◑]",    "Moon Watcher",     "Active on 4 consecutive full moon nights"),
]
