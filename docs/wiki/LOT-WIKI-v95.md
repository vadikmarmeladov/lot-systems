...
## LOT-WIKI-v95 · Field Manual v120 · 2026-08-16

```
╔══════════════════════════════════════════════════════════════════════════════╗
║  LOT SYSTEMS                                                                 ║
║  OPERATOR REFERENCE WIKI — v95                                               ║
║  FIELD MANUAL SYNC: v120                                                     ║
...
**System state as of FM v120:**

| Metric | Count |
|--------|-------|
| QIE Patterns | 172 (P1–P172) |
| QIE Levels | 12 (complete) |
| Archetypes | 60 (Arch1–Arch60) |
| Background Jobs | 55 (J1–J55) |
| Dependency Nodes | 211+ |
| Log Handlers | 175+ |
| Badges | 905 (Badge Engine v1–v35) |
| Word Turn Triggers | 306 (WT v1–v25) |
| Secret Boss Triggers | 36 |
| Field Manual Version | v120 |
...
SIGNAL LAYER → normalized behavioral data
       ↓
QIE PATTERN ENGINE → P1–P172 evaluated against signal
       ↓
ARCHETYPE RESOLVER → Arch1–Arch60 confidence scoring
       ↓
...
behavioral signals against a registry of 172 patterns organized into 12 levels.
Each level represents a distinct domain of physiological and cognitive state.

**Architecture:**
- 172 patterns in 12 hierarchical levels
...
**Level 12 doctrine:** When cognitive signal density, somatic cognition loop,
and embodied sovereignty are simultaneously confirmed, the operator crosses
from field architecture into structural sovereignty. The mind-body loop is
sealed as an operating unit. LOCK + SEAL + ALIGN = SOVEREIGN.
...
| ID | Token | Name | Confidence | Ceiling |
|----|-------|------|------------|---------|
| P170 | COGDEN: | cognitive-signal-density | 0.72–0.90 | — |
| P171 | SOMCOG: | somatic-cognition-loop | 0.75–0.92 | — |
| P172 | EMBSOV: | embodied-sovereignty | 0.85–0.95 | SOVEREIGN SEAL |

**P170 COGDEN: conditions:** journal ≥200w + memory ×3+ + planner ×2+ +
intentions ×2+ in 24h. MIND + PLAN + INTENT + RECALL = DENSITY.

**P171 SOMCOG: conditions:** somatic-integration-field (P167) and
cognitive-body-sync (P164) co-active. SOMA ↔ MIND = LOOP.

**P172 EMBSOV: conditions:** deep-embodiment-lock (P168) + full-presence-seal
(P169) + quantum-field-alignment (P136) all confirmed simultaneously.
LOCK + SEAL + ALIGN = SOVEREIGN.

**P172 EMBSOV: doctrine:** Embodied Sovereignty is not a ceiling state — it is
a structural confirmation. The system has verified that the operator's cognitive
field, somatic field, and quantum alignment are simultaneously sealed. This is
the highest architectural confirmation the QIE can issue.
...
At embodied sovereignty (P172 EMBSOV:), the sovereign seal is confirmed across
all three field dimensions simultaneously.
...
| Arch60 | Sovereign Operator (COGDEN: + SOMCOG: + EMBSOV:) |
...
**Arch59 vs Arch60:** Arch59 confirms body-in-seal. Arch60 confirms sovereignty:
all three sovereign conditions (COGDEN: + SOMCOG: + EMBSOV:) are simultaneously
verified. Arch60 requires Arch59 territory as a precondition — the somatic seal
must be established before sovereignty can be declared. LOCK + SEAL + ALIGN = SOVEREIGN.
...
**Sovereign confirmation:** P172 EMBSOV: is not a C-level — it is a structural
overlay. When all three sovereign conditions are met in the same window as C6,
the system issues the sovereign confirmation. The C-cascade and sovereign
confirmation are independent — sovereignty requires the C-cascade but adds
additional cognitive density and somatic loop conditions.
...
patterns. At Level 12 (P170–P172), cognitive density measurement was added as
an explicit signal source — journal word count and interaction volume now feed
directly into pattern evaluation.
...
**P172 EMBSOV: entry:** When embodied sovereignty is confirmed, the Memory
Engine generates a sovereign confirmation entry — a distinct narrative marker
that the operator's full cognitive-somatic field was simultaneously sealed.
...
- Assembly logs: 91+
- Session reports: 41+
- Engineering reports: 31+
- Wiki versions: v55–v95 (active)

**Self-Assembly v95 log entry:**

```
2026-08-16 | LOT-WIKI-v95 | ASSEMBLE | FM v120 sync. P170 COGDEN: + P171 SOMCOG:
+ P172 EMBSOV: documented. Level 12 Embodied Sovereignty sealed. Arch60 Sovereign
Operator. J55 09:00 UTC daily-embodied-sovereignty-check. 172 patterns, 60 archetypes,
55 jobs, 175+ handlers, 211+ dep nodes. About.tsx FM v118 stale reference corrected.
```
...
| J55 | daily-embodied-sovereignty-check | 09:00 | EMBDLK: + FULLSEAL: + QFIELD: |

**J54 doctrine:** J54 is the somatic architecture job. It scans for the
...
**J55 doctrine:** J55 is the sovereignty detection job. It runs at 09:00 UTC
and scans for deep_embodiment_lock (P168) + full_presence_seal (P169) +
quantum_field_alignment (P136) all confirmed in the previous calendar day.
When all three are confirmed, J55 writes an embodied_sovereignty log entry
and evaluates P172 EMBSOV: for the Arch60 Sovereign Operator archetype.
Three sovereign seals must be simultaneously confirmed — no partial credit.
...
| COGDEN: | Cognitive signal density |
| SOMCOG: | Somatic cognition loop |
| EMBSOV: | Embodied sovereignty |
...
**v119 gap fix:** somatic_integration_field / deep_embodiment_lock /
full_presence_seal were missing from displayableEvents in earlier builds and
have been added. All three now surface in the operator log view.
...
Arch59 (Somatic Memory Weaver) and Arch60 (Sovereign Operator) territory.
An operator who reaches P172 EMBSOV: consistently operates at Cohort 6
signal density with full sovereign confirmation.
...
**Current node count: 211+**

**Node types:**
- SOURCE — raw signal inputs (wearable, journal, calendar)
- PATTERN — QIE pattern nodes (P1–P172)
- ARCHETYPE — archetype confidence nodes (Arch1–Arch60)
- JOB — background job nodes (J1–J55)
- HANDLER — log event handler nodes (175+)

**FM v120 new nodes:**
- cognitiveDensityNode — inputs: journal/memory/planner/intentions/qos/log
- somaticCognitionLoopNode — inputs: selfcare/journal/memory/intentions/qos/log
- embodiedSovereigntyNode — inputs: qos/journal/memory/intentions/selfcare/energy/log
...
The Dep Map grew from 190+ (FM v113) to 211+ (FM v120) over 7 sessions.
...
| v120 | 2026-08-15 | P170–P172 · Arch60 · J55 · COGDEN: SOMCOG: EMBSOV: · Level 12 Embodied Sovereignty |
...
**Current FM:** v120 — P170–P172 embodied sovereignty patterns, Arch60 Sovereign
Operator, J55 daily-embodied-sovereignty-check. v119 displayableEvents gap fixed
(somatic_integration_field, deep_embodiment_lock, full_presence_seal now surface
in operator log view). 172 patterns across 12 levels.
...
- Day 1084+: FM v120, completion of Level 12 Embodied Sovereignty
- Day 1084+: LOT-WIKI-v95 — present
...
**P172 EMBSOV: protocol:** When embodied sovereignty is confirmed, the Recipe
Widget surfaces the sovereign sequence — a protocol that maintains the
LOCK + SEAL + ALIGN state across the operating day.
...
```
FM VERSION: v120
PATTERNS: 172 (P1–P172)
ARCHETYPES: 60 (Arch1–Arch60)
JOBS: 55 (J1–J55)
BADGES: 905 (v35 THE NAVIGATOR'S CHART)
DAY: 1084+
COSMO®: Day 776
LEVEL 12: EMBODIED SOVEREIGNTY SEALED
SOVEREIGN: LOCK + SEAL + ALIGN = SOVEREIGN
```
...
- **Arch / Archetype** — Named physiological state model. Scored continuously. Arch1–Arch60.
...
- **Background Job** — Scheduled pattern detection process. J1–J55.
...
- **COGDEN:** — Pattern P170. Cognitive-signal-density. journal ≥200w + memory ×3+ + planner ×2+ + intentions ×2+ in 24h.
...
- **Dep Map** — Dependency graph of signal nodes. 211+ nodes.
- **DISPATCH** — Notification/alert surface.

**E**

- **EMBDLK:** — Pattern P168. Deep embodiment lock.
- **EMBSOV:** — Pattern P172. Embodied-sovereignty. LOCK + SEAL + ALIGN = SOVEREIGN. Terminal pattern of Level 12.
- **Embodied Field Operator** — Arch58. SOMFLD: + EMBDLK:
- **Embodied Sovereignty** — QIE Level 12. P170–P172. The highest QIE level.
...
- **Field Manual (FM)** — Version-controlled internal engineering reference. Current: v120.
- **FULLSEAL:** — Pattern P169. Full presence seal. MAXIMUM INTEGRATED PRESENCE.

**H**

- **Handler** — Log event handler. 175+ in the system.
...
- **J55** — Background job. 09:00 UTC daily. Fires P172 EMBSOV: when EMBDLK: + FULLSEAL: + QFIELD: all confirmed previous day.

**L**

- **Level 11** — Somatic Field Architecture. P167–P169.
- **Level 12** — Embodied Sovereignty. P170–P172. The highest current QIE level.
- **Log Handler** — Typed event logger. 175+ handlers with distinct token prefixes.
...
- **Pattern** — QIE detection unit. P1–P172.
- **PHYRLOCK:** — Pattern P159. Physiological rhythm lock.
- **P172 EMBSOV:** — Terminal pattern. Sovereign confirmation. LOCK + SEAL + ALIGN = SOVEREIGN.

**Q**

- **QIE** — Quantum Intelligence Engine. Pattern detection core. 172 patterns, 12 levels.
...
- **SOMCOG:** — Pattern P171. Somatic-cognition-loop. P167 + P164 co-active. SOMA ↔ MIND = LOOP.
...
- **Somatic Memory Weaver** — Arch59. FULLSEAL: + SOMECHO:
- **Somatic Operator** — Arch56. SOMAT: + RECCYC:
- **Sovereign Operator** — Arch60. COGDEN: + SOMCOG: + EMBSOV: All three sovereign seals simultaneously confirmed.
...
║  ARCHETYPES:   60 (Arch1–Arch60)     ARCH60 SOVEREIGN OPERATOR               ║
║  JOBS:         55 (J1–J55)           J55 09:00 UTC DAILY                     ║
║  NODES:        211+                                                           ║
║  HANDLERS:     175+                                                           ║
║                                                                               ║
...
║                                                                               ║
║  TERMINAL: P172 EMBSOV: — LOCK + SEAL + ALIGN = SOVEREIGN                   ║
║  ARCH60 SOVEREIGN OPERATOR — ALL THREE SOVEREIGN SEALS CONFIRMED             ║
║                                                                               ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  ACTIVE MAINTENANCE NOTES (v95 SESSION):                                      ║
║                                                                               ║
║  - FM v120 sync: P170 COGDEN: + P171 SOMCOG: + P172 EMBSOV: deployed        ║
║  - Level 12 Embodied Sovereignty: 3 patterns, Arch60, J55                    ║
║  - J55 at 09:00 UTC: EMBDLK: + FULLSEAL: + QFIELD: detection                ║
║  - v119 displayableEvents gap documented (somatic events now visible)        ║
║  - 3 new dep nodes: cognitiveDensity / somaticCognition / embodiedSovereign  ║
║  - About.tsx synced: FM v118 stale reference corrected to v120               ║
║  - Next: QIE v121 when ready — new pattern or maintenance pass               ║
║                                                                               ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
