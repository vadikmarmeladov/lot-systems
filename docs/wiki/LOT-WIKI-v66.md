...
### Revision: v66 · Field Manual Sync: v72 · Date: 2026-06-27 · Day 1023+
...
Field Manual:           v72
Wiki version:           v66
Day counter:            1023+  (as of 2026-06-27)
...
Day counter:             1022+ → 1023+
New sections:            Section 7 expanded to full cohort profiles
                         Section 16 added (Word Turn Engine)
                         Section 26 expanded vocabulary index
No engineering delta:    FM v72 unchanged · patterns/archetypes/jobs
                         unchanged since June 25 build
```
...
**The dep map:** The Widget Dependency Map (WIDGET_DEPENDENCY_MAP) is the internal wiring graph. 126+ nodes in 4 tiers. Tier 0 = raw inputs (mood, memory, log). Tier 3 = meta-aggregate surfaces (quantumOS, systemProgress, quantumPersonality).
...
Complete registry of all 86 QIE patterns.
...
P85  adaptive-momentum-window    0.75–0.90 P83 systemic-thinking-mode + P80
                                            signal-momentum-lock simultaneous ←v72
P86  vitality-strategy-peak      0.78–0.92 P82 circadian-vitality-peak + P83
                                            systemic-thinking-mode simultaneous ←v72
──────────────────────────────────────────────────────────────────────
```
...
J17   daily-morning-intention-launch   11:00 UTC daily   Scans 00–09 UTC; writes MCL:          ←v65
...
ADV. MOM.    ADAPT-MOM: Adaptive momentum window (P85)             ←v72
VSTRAT       VSTRAT:    Vitality strategy peak (P86)               ←v72
```

### LOG EVENT HANDLERS (85+)

85+ handlers registered as of v72. Notable recent additions:
...
46 event types whitelisted in `displayableEvents`. All 46 are visible to the operator in the log stream.
...
102 trigger words through v8. v9 and v10 added 12 each. Total: 126 trigger words.
...
v72   P84 longitudinal-drift · P85 adaptive-momentum-window ·
      ...
      COCKPIT-RULE military pass on 5 handlers · ADAPT-MOM: + VSTRAT: ·
      126+ dep nodes (longitudinalDriftMonitor · qosModeWatcher ·
...
FIELD MANUAL        The About.tsx operator reference document.
                    Canonical authoritative source. Current: v72.
...
QIE                 Quantum Intent Engine. Client-side pattern
                    recognition. 86 patterns. Zero server comms.
...
## 27. SYSTEM STATE SNAPSHOT — 2026-06-27

```
╔══════════════════════════════════════════════════════════════════╗
║  LOT SYSTEM STATE — FIELD MANUAL v72 — DAY 1023+               ║
╠══════════════════════════════════════════════════════════════════╣
...
║                                                                  ║
║              LOT-WIKI-v66 · Field Manual v72                     ║
║              June 27, 2026 · Day 1023+                          ║
║                                                                  ║
...
*LOT-WIKI-v66 · Layers of Time · Field Manual Sync v72 · 2026-06-27*
*Next: LOT-WIKI-v67 — sync to Field Manual v73+*
