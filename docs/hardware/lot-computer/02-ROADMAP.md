...
## Phase 0 — Concept freeze (this session)
...
- [x] API integration surface identified against the live codebase
      (`05-SOFTWARE-API-CONNECTOR.md`)
- [ ] Vadik sign-off on the 5mm-vs-9mm height tension (§1 of the product plan)
- **Exit criterion:** written plan approved, no purchases yet.
