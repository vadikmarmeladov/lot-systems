...
LOT-MAIL            In-app "/email to <name>" primitive: Log command -> lot_emails table -> Sync SSE delivery; recipient-agnostic (unresolved rows kept, not rejected)  B  20260720
```
