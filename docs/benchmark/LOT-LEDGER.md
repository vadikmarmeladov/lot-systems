...
20260903-01    | SELF-ASSEMBLY| BASICS TAB — LOT-FM-001 Month 1 rebuilt on current master: public /basics route (no login, matches /status pattern) + in-app SPA tab, 23-item DRAFT ration ledger, doctrine, price line, live status-line · superseded stale beautiful-johnson-56p7ov/6815f550 (150K lines behind master, was login-gated only — never actually public) | GREEN | (pending tag) | WORDS: 1179 (median 576) — trend ↑
