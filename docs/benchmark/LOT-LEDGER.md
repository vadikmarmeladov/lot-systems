...
20260830-01    | ENGINEERING | Calendar widget — Track/Stop time logging (calendar_time_logged, per-entry running total), CalendarEventToast due-today + logged alerts (calendarAlerts nanostore FIFO), handleAddEntry reset-on-success reliability fix, displayableEvents + Logs.tsx CAL [TIME]: wiring | GREEN | (pending tag) | WORDS: 725 (median 540) — trend ↑
