...
20260717-01    | ENGINEERING | CalendarWidget — time-tracking (time/duration/remind on entries) + Log-backed calendar_alert scheduler (reminder/start/end stages) + Calendar Ops toast | GREEN  | (pending) | WORDS: 340 (median ~540) — trend ↓
