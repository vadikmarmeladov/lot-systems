...
20260823-01    | CORPORATE    | QI·46 naming reconfirmed (5 candidates weighed, no rename) · Voice Calibration Addendum v0.3 — Calibration Loop reads expressive pattern not consciousness, COSMO® boundary made explicit, fixed-male-voice directive narrowed to per-subscriber register | GREEN | (pending tag) | WORDS: 535 (median ~530) — trend =
