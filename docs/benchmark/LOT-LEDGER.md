...
20260815-01    | CORPORATE    | QI·46 naming locked (5 candidates reviewed, QI·46 confirmed) · QI46 engine spec v0.2→v0.3 · Layer 6 Voice Calibration Node added (tone-to-subscriber register matching, explicitly scoped against Layer 0/1 inputs only) | GREEN | (pending tag) | WORDS: 612 (median ~540) — trend =
