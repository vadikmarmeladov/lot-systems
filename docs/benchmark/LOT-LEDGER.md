...
20260809-01    | ENGINEERING | CalendarWidget.tsx time tracking — start/stop session, localStorage persistence across reload, 12h stale-session auto-terminate guard. TRK-INIT:/TRK: military log handlers (Logs.tsx). calendar_timer_start/calendar_time_log added to displayableEvents whitelist | GREEN | a93314f8 | WORDS: 420 (median 540)
