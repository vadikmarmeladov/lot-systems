...
20260816-01    | ENGINEERING  | Calendar widget: optional HH:mm time-of-day on entries · T-MINUS live countdown to next timed entry · 20s hidden-tab-gated alert engine (calendar_alert Log write + military-log ASCII-bordered toast + native Notification) · localStorage notified-id dedup (calendar_notified_ids_v1) · time shown in entry lists | GREEN | (pending tag) | WORDS: 685 (median ~540) — trend ↑
