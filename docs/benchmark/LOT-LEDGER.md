...
20260810-01    | CORPORATE    | COSMO® SLATE v1 — hardware computer plan (2-piece stainless steel pager, camera, weather sensor, round display, LOT API connector), BOM w/ sourcing links, PCBWay manufacturing plan for 100-unit pilot, firmware doc, software doc, PDF owner's manual generated | GREEN  | (pending tag) | FILES: 7 (+1051 md lines, +1 PDF)
