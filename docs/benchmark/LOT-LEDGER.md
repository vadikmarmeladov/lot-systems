...
20260812-01    | ENGINEERING | LOT-FM-001 Basics tab M1 — OPEN TAB live in-app (/basics tab) + public (GET /basics, own bundle) · 23-item ration ledger + doctrine + price line, fixed non-theme visual spec · M2/M3 scoped in LOT-FM-001 manual, not built · Cross-Session Continuity doctrine clause minted (read 2 prior unshipped BASICS attempts, re-implemented vs cherry-pick) | GREEN | (pending tag) | WORDS: 747 (median 449, n=67) — trend ↑
