...
20260904-01    | ENGINEERING  | CalendarWidget: HH:mm time-of-day field + fromNow() countdown + tombstone-based cancel (calendar_entry_removed) · CalendarAlertToast (new) — 30s-poll military SCHEDULE ALERT banner + calendar_alert log · Logs.tsx CAL-ALERT:/CAL-CANCEL: handlers | GREEN  | 434cc398 | WORDS: 722 (median 449)
