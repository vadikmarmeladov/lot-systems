...
20260906-01    | ENGINEERING | Calendar widget: time-of-day per entry, live ticking clock, T-minus/OVERDUE status, deduped calendar_alert log dispatch on overdue crossing · CAL: block upgraded with SECTOR framing · CAL-ALERT: block added (bold, bracket status) | GREEN | (pending tag) | WORDS: 493 (median 542) — trend ↓
