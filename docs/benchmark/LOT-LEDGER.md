...
20260810-01    | ENGINEERING | Calendar widget upgrade: optional HH:MM time field · isolated live clock/T-minus countdown (RENDER-ISOLATION) · Today panel with EXECUTE/ALERT/STANDBY/ELAPSED status · CAL [EXECUTE]/[ALERT] military alert toast (60min window, 30s auto-dismiss, ACK) · Logs.tsx CAL [TYPE]: bracket renderer with SCHEDULED/ELAPSED. Superseded unshipped claude/gifted-lovelace-cZOWR 978cf52a (409-file stale diff, reimplemented fresh instead of cherry-picked) | GREEN | 172b3a96 | WORDS: 796 (median 540) — trend ↑
