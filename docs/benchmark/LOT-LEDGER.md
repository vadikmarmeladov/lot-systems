...
20260802-01    | ENGINEERING  | BASICS tab — LOT-FM-001 Month 1 (public OPEN TAB /open-tab, no-auth ledger) + Month 2 (UPGRADE/ROSTER state machine: USERSHIP→PENDING→ON STRENGTH, STAND DOWN, issue log, UserTag.Basic) · corrected prior BEST candidate's non-public M1 gap | GREEN  | (pending tag) | WORDS: 640 (median ~500)
