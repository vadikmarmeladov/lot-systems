...
20260728-01    | ENGINEERING | Basics tab M1 — OPEN TAB live: 23-item ration ledger (nomenclature+cadence, COGS withheld), doctrine statement, USD 100/mo price line, StatusLine component, LOT-FM-001 terminal tokens (font-term, fixed ink/ground). Nav placeholder wired to /basics route. Read-only. | GREEN | (pending tag) | WORDS: 460 (median 540)
