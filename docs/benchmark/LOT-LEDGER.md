...
20260808-01    | ENGINEERING | Calendar widget — time-of-day field on entries (HH:mm input, date+time sort, time-aware upcoming filter) · CalendarAlertToast.tsx military-grade T-MINUS/SITREP alerts (localStorage dedupe, 30s poll, hidden-tab/off-route gated) · CAL: log block shows time · submit-guard against double-fire · manifest Calendar Alerts row repointed (prior branch gifted-lovelace-cZOWR/978cf52 unreachable, verified via fetch+cat-file before rebuilding) | GREEN | (pending tag) | WORDS: 520 (median 540)
