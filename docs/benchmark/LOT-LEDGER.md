...
20260907-01    | ENGINEERING | LOT-FM-001 BASIC RATION — Month 1/3: OPEN TAB public ledger (23-item load, nomenclature+cadence, COGS withheld) · doctrine authored (100/mo, 70.26% margin vs 60% floor, $29.74 landed vs $40 ceiling) · /basics route: standalone public entry (logged-out) + in-app Basics nav tab (logged-in) from one shared component · military-spec visual scope (mono, #000/#fff, 2px rules, square corners) isolated to this surface | GREEN | (pending tag) | WORDS: 675 (median 541) — trend ↑
