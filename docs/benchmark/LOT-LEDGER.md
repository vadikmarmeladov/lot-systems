...
20260817-01    | SELF-ASSEMBLY | QI·46 engine name confirmed (existing spec canonical, no rename) · Phase 0 corpus scaffold (/corpus 6 source dirs + tagging schema) · Checkpoint 0 explicitly HELD, no data populated · scope boundary documented against literal soul/biometric claims | GREEN | 98971f2 | WORDS: 558 (median 550)
