...
20260803-01    | ENGINEERING | LOT Email — /email to <name> Log command, email_messages table + sourceLogId dedup, recipient resolved via Community/Cohort pool, SSE email_message scoped to recipient, MAIL: block in Sync · fixed .gitignore server/ swallowing new src/server/ files · fixed email_sent missing from displayableEvents whitelist · flagged parallel ledger/report-location drift (docs/assembly + docs/ root vs this file) for S-2 consolidation | GREEN | d1e715e | WORDS: 1212 (median 542)
