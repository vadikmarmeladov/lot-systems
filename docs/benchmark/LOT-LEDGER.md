...
20260703-01    | SELF-ASSEMBLY| LOT-FM-001 Basics Tab — OPEN TAB live (M1, 23-item ledger+doctrine+price, verified in headless browser) · M2 upgrade/roster/stand-down state machine + M3 issue engine/manifest card built (unverified, no DB in sandbox) · .gitignore server/ overbreadth bug fixed | GREEN | 4dc83f6 | WORDS: 948 (median 396) — trend ↑
