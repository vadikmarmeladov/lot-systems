...
20260718-01    | SELF-ASSEMBLY| LOT-FM-001 M1 — Basics Tab: OPEN TAB, 23-item BASIC ration manifest (rations.ts), StatusLine primitive, doctrine + price line, router/nav/tab-panel wiring, Month 2/3 plan filed | GREEN  | b7f6dd3 | WORDS: 520 (median ~540) — trend =
20260718-02    | SELF-ASSEMBLY| LOT-FM-001 intake correction — Basics rebuilt as $399/mo surprise box (AI $99 included); RATION_POOL module+previewInBasics fields, BIOSTATION_SEQUENCE (12mo constructor), PLANS tiers (AI/BASICS/SELF_CARE/HOME/KIDS) | GREEN  | (pending) | WORDS: 480 (median ~540) — trend =
