...
20260825-01    | ENGINEERING | Calendar widget: time (HH:mm) + duration fields on entries · onError->FAILED toast on log-create · military-grade bracket/mono alert toast (LOGGED/FAILED/T-MINUS/OVERDUE, 60s poll ±15min window, alertedRef dedup) · recordTimeTrackingSignal added alongside recordCalendarSignal · Logs.tsx CAL: block renders time/duration · fix: dayjs format-string parse silently no-ops in this repo's wrapper (no customParseFormat) — entryStatus() rewritten with .hour()/.minute() setters | GREEN | db1128fe | WORDS: 606 (median 449, recomputed across 68 entries) — tag benchmark-20260825-01 PUSH-DEFERRED (403, no tag-ref permission this session)
