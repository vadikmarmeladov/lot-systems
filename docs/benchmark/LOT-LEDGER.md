...
20260903-01    | ENGINEERING | Calendar widget: optional per-entry time field + T-MINUS countdown to next scheduled item · CAL: Log handler now shows TIME + SCHEDULED/ELAPSED status · new CalendarAlertToast military-style event notification (15-min lookahead, localStorage-deduped, wired next to CalendarWidget) · recordCalendarSignal carries time | GREEN | (pending tag) | WORDS: 612 (median 540) — trend =
