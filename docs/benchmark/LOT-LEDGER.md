...
20260718-01    | ENGINEERING | LOT Computer v1.0 — hardware spec + BOM (PCBWay/Xometry sourced) + firmware doc + software connector doc (POST /api/logs COPY signal, live endpoint) + PDF manual · restarts lost brave-lamport COSMO Hardware record (t9z5u8, never merged) | GREEN | (pending) | WORDS: 4492 raw → 184 summary (ratio 24.4:1)
