...
20260831-01    | SHIP        | LOT® Email — cherry-picked BEST "LOT Mail" (determined-turing-f6bw7r) onto session branch: /email trigger in Log, inline compose, Sync Chat|Mail tab strip + unread SSE badge, ChatCatalystWidget ✉ Mail cohort button, POST/GET /api/mail·inbox·unread-count, lot_mails migration. 3 merge conflicts resolved (2mo master drift), no logic dropped. Master merge deferred — session restricted to its own branch | GREEN | f502746b | WORDS: 582 (median 559) — trend ↑
