...
20260708-01    | ENGINEERING | LOT-FM-001 BASICS M1+M2+M3 — public OPEN TAB ledger, roster state machine (PENDING/ON_STRENGTH/STEADY_STATE), issue engine w/ COGS-ceiling gate (verified >=60% margin live), STAND DOWN. Fixed .gitignore bug silently swallowing new src/server/* files. Live E2E verified over real HTTP against local Postgres. | GREEN | 5223b5e2 | WORDS: 886 (median ~540) — trend ↑
