...
20260829-01    | CORPORATE    | COSMO Terminal (T-1) hardware computer -- plan + BOM + firmware/software specs + PDF manual; MANIFEST COSMO-Hardware row corrected (stale branch/hash) | GREEN | (pending tag) | WORDS: 486 (median ~495) -- trend =
```
