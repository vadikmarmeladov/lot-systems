...
20260831-01    | ENGINEERING  | Calendar widget: time-of-day field on entries · EVT [DUE] military-style due-alert toast (visibility-gated 20s poll, localStorage ack dedup) · entry removal (PUT /logs/:id delete branch extended to calendar_entry) · fixed missing userId ownership check on PUT /logs/:id (IDOR) · CAL: block gains TIME row in Logs.tsx | GREEN | (pending tag) | WORDS: 768 (median 559) — trend ↑
