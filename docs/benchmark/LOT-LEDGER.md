...
20260727-01    | ENGINEERING | BASICS M1 shipped forward — LOT-FM-001 OPEN TAB live at /basics: 23-item ration ledger (NUTRITION/HEALTH/HYGIENE/EQUIPMENT), doctrine lines, USD 100.00/MO price line, live status-line (ON STRENGTH/USERSHIP/NONE). Cherry-picked isolated commit from orphaned BEST branch beautiful-johnson-56p7ov (never merged) rather than the stale full branch; re-verified green against current master | GREEN | 6a4b0cce | LINES: +293 (median 388)
