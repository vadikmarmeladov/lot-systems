...
20260811-01    | ENGINEERING | Calendar widget: consolidated military-grade alerts (live clock, T-minus countdown, EXECUTE/ALERT/STANDBY/ELAPSED status, alert overlay, OS Notification API opt-in) from gifted-lovelace-cZOWR (978cf52a, unshipped since 2026-05-27) + bg-base->bg-bac fix (invalid Tailwind token, overlay was rendering transparent) + Logs.tsx CAL renderer now shows full entry text/time/status instead of type+date only · FINDING: this exact feature independently reimplemented ~10x across 2026-05-27..2026-08-09 on disposable branches, never merged — manifest's 06-27 "already merged" note was stale; fetched branches directly to confirm rather than trusting it · MANIFEST-DRIFT doctrine clause added (rev N->O) | GREEN | 57d928a7 | WORDS: 999 (median 449, n=67 recomputed)
