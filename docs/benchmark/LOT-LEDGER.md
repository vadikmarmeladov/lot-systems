...
20260816-01    | ENGINEERING | Astrology block personalization: getAstrologyAffinity() personal rokuyo frequency from own Logs history, wired into System.tsx Astrology block (both layouts) · QuantumSignWidget Astrology patch now driven by real getRokuyo/getMoonPhase (was unrelated day-of-year rotation, disagreed with System dashboard) · Logs.tsx LogContainer hover context surfaces astroRokuyo/astroMoonPhase for any log entry, not just system_snapshot | GREEN | (pending tag) | WORDS: 1032 (median 546) — trend ↑
