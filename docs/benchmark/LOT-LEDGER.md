...
20260901-01    | ENGINEERING  | BASICS M1 restore (OPEN TAB, 23-item ration ledger, doctrine) + M2 (UpgradeState PENDING, roster intake, self-service STAND DOWN, UserTag.Basic, admin-gated ON STRENGTH grant) — M3 fulfillment deferred to S-2 supplier decision | GREEN  | 931da836  | WORDS: 784 (median 540) — trend ↑
