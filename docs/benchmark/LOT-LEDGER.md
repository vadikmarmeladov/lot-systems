...
20260831-01    | CORPORATE    | QI·46 Node 2 — Companion Calibration Layer, gated positioning addendum (Node 1 unchanged) · COSMO® Companion-Voice classifier authored, not implemented | GREEN  | (pending tag) | WORDS: ~430 (median ~495, ESTIMATE) — trend ↓
