...
20260720-01    | ENGINEERING  | Calendar widget: optional per-entry time (HH:mm) · due/overdue/scheduled status (getEntryStatus) · in-widget calm notification toast (once-fire, presence-gated, no OS push) · CAL: log handler + Next: block + Field Manual synced · TOOLCHAIN-DRIFT fix: TS 6.0.2 rejected ignoreDeprecations pin -- moduleResolution bundler, baseUrl dropped, sequelize/types/index · npm install (node_modules was absent) · TAG-PUSH-GAP found (branch push OK, tag push 403) | GREEN | ae23dd11 | WORDS: 540 (median 495) -- trend =
