...
20260816-01    | ENGINEERING | LOT Email v1 — /email to [name] trigger in logTriggers.ts · Logs.tsx posts via existing useCreateChatMessage so it surfaces in Sync (no new table/route) · cohort-match tagging + recordSignal('lot_email_sent') · CohortConnectWidget "✉ Email" action → Log tab | GREEN | 6a41c22 | WORDS: ~430 (median 542) — trend ↓
