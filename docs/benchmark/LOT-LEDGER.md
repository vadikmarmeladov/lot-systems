...
20260815-01    | CORPORATE    | COSMO® Node v1.0 — hardware/BOM/roadmap spec recovering lost "COSMO® Cube" manifest line item under new name · 2-part stainless body (40x40x5mm polished plate + camera/screen/button face) · PCBWay fab+CNC · ESP32-S3/BME280/BME680/Qi BOM · 2 new LOT API endpoints (device/notify, device/log) · COPY button → Log tab · 100-unit pilot roadmap · firmware/software/manual docs scoped, not yet written | GREEN | (pending tag) | WORDS: 620 (median 540)
