...
20260705-01    | ENGINEERING  | BASICS TAB — LOT-FM-001 M1+M2+M3 in one session: 23-item ledger, upgrade state machine, load engine + fulfillment + printed manifest card | GREEN  | (pending) | LINES: +393 across 14 files
