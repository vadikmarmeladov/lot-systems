...
20260704-01    | ENGINEERING  | Basics Tab M1+M2+M3 — LOT-FM-001 OPEN TAB + in-app tab, UPGRADE/STAND DOWN state machine, cadence load engine + issue log, basic_issues table | GREEN  | (head) | WORDS: 999 (median 396) — trend ↑
