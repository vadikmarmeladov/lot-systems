...
20260725-01    | ENGINEERING  | Calendar widget military-time tracking + T-MINUS countdown + CAL: log block text/time fix + Memory Engine calendar_entry wire-in (DUAL-MODULE flagged: memory/ dir refactor is dead code) | GREEN  | (pending tag) | WORDS: ~520 (median 495)
