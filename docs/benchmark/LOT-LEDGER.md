...
20260805-01    | ENGINEERING  | LOT-FM-001 BASICS M1 landed (cherry-picked forward, TabPanels conflict resolved) + M2 built: UPGRADE/STAND DOWN state machine in user.metadata.basics, roster intake, Job 45 steady-state promotion | GREEN  | bb9c9422 | WORDS: 540 (median 540)
