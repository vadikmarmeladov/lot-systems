...
20260716-01    | CORPORATE    | QI·46 engine spec v0.2 -> v0.3 — Section IX Honest Boundaries added (Calibration Loop = journal+self-report+behavioral metadata, not literal soul/consciousness read; COSMO® screens output, not subscriber) | GREEN  | (pending tag) | WORDS: ~340 (median ~495) — trend ↓
