...
20260718-01    | ENGINEERING  | LOT® Mail shipped to branch — cherry-picked + rebased the 06-12 build (/email in Log, Sync Mail tab, Cohort→Mail button, per-user SSE), fixed goTo('log')->'logs' bug, resolved master drift | GREEN  | 91afea77 | WORDS: 1141 (median 537) — trend ↑
20260718-02    | ENGINEERING  | Benchmark re-verify — LOT Mail green state confirmed unchanged, tag-push 403 confirmed non-transient (2nd occurrence) | GREEN  | (pending hash) | WORDS: 578 (median 541.5) — trend ↓
