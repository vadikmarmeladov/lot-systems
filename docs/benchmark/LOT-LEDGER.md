...
20260824-01    | ENGINEERING | LOT Mail rebuild — /email Log cmd resolves firstName -> DirectMessage; fixed dropped 'direct_message' SSE case; Sync "LOT Mail" inbox panel; CohortConnectWidget relabeled "LOT Community", dead Send-message stub now opens the DM thread | GREEN | (pending tag) | WORDS: 676 (median 495) — trend ↑
