...
20260707-01    | ENGINEERING | Session fixes: RecipeWidget 3-turn flow (33-lang farewell pool) · MonthlyPulseWidget Month N/12 Usership · Tag fill+mirror guard · nav active tab hover · composeLocalStory poetic rewrite · Settings copy update · tsconfig ignoreDeprecations "5.0" build gate | GREEN  | c3ef586 | WORDS: 492 (median ~540)
20260718-02    | ENGINEERING | /story fix: journal filter used dead event names (log_entry/journal), never matched real 'note' entries · added day/week/month/year compression periods · getLogContext() enriched with sky + zodiac + moon phase (no migration, JSONB) · moon emoji surfaced in Log hover context · Arcade gamification noted PROVISIONAL for future scoping | GREEN  | (pending tag) | WORDS: 1165 (median ~540) — trend =
