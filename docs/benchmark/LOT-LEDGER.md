...
20260901-01    | ENGINEERING | Astrology block personalization: computeAstrologyAffinity() reads user's own emotional_checkin history (context.astroRokuyo already stored per-entry) back as a sample-gated positive-mood-by-rokuyo read, surfaced in System.tsx astrology tab and carried on the daily QIE astrology signal; Logs.tsx ASTRO line extended to all 4 fields + added to BIO block | GREEN | (pending tag) | WORDS: ~530 (median 559)
