...
20260720-01    | ENGINEERING | /story period scoping (day/week/month/year via parseStoryPeriod) · POST /story date-filtered by period + period-scaled word target + PERIOD SIGNAL COUNTS in prompt · Job 38 monthly-lot-ai-story (1st of month 18:00 UTC) + Job 39 yearly-lot-ai-story (Jan 1 18:00 UTC), mirror Job 24 template compression · STORY: block renders W/M/Y generically · badges: chronicler (word-turn) + temporal_cartographer (achievement_rpg, all 4 periods used) | GREEN | ff5d08c2 | WORDS: ~520 (median 540) — trend =
20260720-02    | ENGINEERING | Story digest on 2 more Usership-gated surfaces: Public Profile (PublicProfile.storyDigest type + public-api.ts profile route reusing showMemoryStory gate + PublicProfile.tsx Story: block) · monthly email (composeMonthlyStoryDigest computed inline from already-fetched logs — deliberately not read from metadata to avoid Job 38 same-day ordering race — new "This Month, Compressed" section in HTML+text templates) · completes the 3-surface story-display plan (Public Profile + email + on-demand /story from SR-20260720-01) | GREEN | (see commit) | WORDS: ~480 (median 540) — trend =
