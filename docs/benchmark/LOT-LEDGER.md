...
20260725-01    | ENGINEERING | /story day/week/month/year compression scoping (Together AI, period-aware prompt+token budget, metadata.period) · /system help derived from logTriggers RULES via new listCommands() — fixed silent drift (/sil was missing from the hand-written list) · Command Registry Single Source doctrine folded | GREEN | e1ccccd | WORDS: 1116 (median 540) — trend ↑
