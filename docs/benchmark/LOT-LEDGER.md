...
20260801-01    | CORPORATE    | LOT® Computer — desk terminal hardware plan + BOM + 100-unit roadmap · firmware spec (ESP32-S3, camera/display/weather/power) · software connector spec (device pairing, SSE push, Copy→/logs, fleet panel, PDF manual pipeline) · scoped distinct from COSMO® and CUBIQ™ · docs-only, no code changed | GREEN | (pending tag) | WORDS: 410 (median 540) — trend ↓
