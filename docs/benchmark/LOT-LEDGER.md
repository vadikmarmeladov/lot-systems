...
20260719-02    | ENGINEERING | Calendar widget — time-of-day entries (metadata.time, <input type=time>, shown in date/upcoming lists) · CAL [DUE] due-time detector (30s poll + visibilitychange catch-up, 5-min window) · military-style toast + calendar_alert Log write · localStorage seen-key dedup (reuses EvolutionMilestoneToast pattern) · calendar_alert added to displayableEvents + Logs.tsx render branch | GREEN | 1f730eb | WORDS: ~520 (median 540)
