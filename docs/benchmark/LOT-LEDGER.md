...
20260816-01    | SELF-ASSEMBLY| BASICS TAB LOT-FM-001 M1 — OPEN TAB forward-ported from stale beautiful-johnson-56p7ov (2mo, pre-TabPanels) onto current master; /basics live, 23-item ration ledger, doctrine, price line, status line; About.tsx row + MANIFEST corrected | GREEN | (pending) | WORDS: 815 (median ~495) — trend ↑
