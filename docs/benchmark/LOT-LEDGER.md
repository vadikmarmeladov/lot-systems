...
20260905-01    | SELF-ASSEMBLY| LOT-FM-001 BASIC ration Month 1 — /basics route live, public OPEN TAB, doctrine + price line + status line + 23-item ration load ledger (nomenclature+cadence, COGS withheld); Months 2/3 (upgrade state machine, billing, fulfillment) explicitly deferred | GREEN | (pending tag) | WORDS: ~700 (median 665)
