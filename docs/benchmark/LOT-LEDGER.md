...
20260811-01    | CORPORATE    | COSMO® Cube v2.0 — full hardware build spec: BOM+real off-the-shelf parts+links (ESP32-S3, OV2640, BME688, BQ51013B), 2-piece stainless enclosure w/ height-budget honesty, LOT API connector (/v1/m2m/notify), PCBWay 100-unit mfg plan ($47-83/unit loaded), PDF manual generator script, v2.0→v2.1→v3.0 roadmap | GREEN  | (pending)  | WORDS: ~1050 (CORPORATE class, excluded from median)
