...
20260819-01     | ENGINEERING  | LOT Email — "/email to <name>" Log trigger posts through existing chat_messages (Sync/Lot Chat); recipientName/recipientUserId columns added, resolved via Op.iLike on users.firstName; Sync renders "✉ → name" tag; recipientUserId is the join point a future Cohort Dating/LOT Community directory would read (neither exists yet — confirmed by search, not built) | GREEN | b982b886 | WORDS: 730 (median 449, N=67) — trend ↑
