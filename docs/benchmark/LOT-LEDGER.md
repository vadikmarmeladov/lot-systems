...
20260718-01    | ENGINEERING  | LOT® Mail shipped to branch — cherry-picked + rebased the 06-12 build (/email in Log, Sync Mail tab, Cohort→Mail button, per-user SSE), fixed goTo('log')->'logs' bug, resolved master drift | GREEN  | (pending hash) | WORDS: 1141 (median 537) — trend ↑
