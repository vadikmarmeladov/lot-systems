...
20260620-01    | ENGINEERING  | LOT Mail — /email to [name] in Log → inbox in Sync · lot_mails table · 3 API routes · SSE · LotMailInbox widget | GREEN  | (post-commit) | WORDS: 342 (median 385)
