...
20260907-01    | ENGINEERING | LOT Email — /email log trigger (Cohort-match-gated recipient resolution) · GET/POST /email-messages (reuses direct_messages table) · Sync Inbox section + SSE 'email_message' · Log render + displayableEvents whitelist · fixed missing direct_messages migration (model+routes were live with no table) | GREEN | 8863c83a | WORDS: 1209 (median 542)
