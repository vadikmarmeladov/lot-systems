...
20260803-01    | PRODUCT      | Basics Tab / LOT-FM-001 BASIC ration, Month 1 of 3 — OPEN TAB live at /basics (read-only): 23-item RATION_MANIFEST + doctrine + $100/mo price line, /api/public/basics-manifest (COGS withheld server-side), LOT-FM-001 manual authored, About.tsx fabricated-branch claim corrected to actual state | GREEN | (pending tag) | WORDS: 520 (median 540) — trend ↓
