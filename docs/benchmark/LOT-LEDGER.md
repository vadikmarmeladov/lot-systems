...
20260817-01    | ENGINEERING | LOT-FM-001 BASIC M1: Basics tab OPEN TAB live — nav slot wired (router+Layout+app.tsx), 23-item ration ledger, doctrine statement, USD100/mo rate line, static STATUS-LINE component, scoped monospace/inversion visual register (Basics.tsx-local, house style untouched). Month 2/3 scoped in MANIFEST §07, blocked on S-2. Env finding: npm ci --legacy-peer-deps over yarn install (proxy-blocked yarnpkg.com) folded into DOCTRINE. | GREEN | (pending tag) | WORDS: 1138 (median 449, n=67) — trend ↑
