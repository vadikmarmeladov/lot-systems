...
COSMO Hardware   | brave-lamport-t9z5u8         | c7d353ef | 14/14 | BEST   | 7     | +2610  | COSMO® Cube — complete hardware computer design v1.0 (SUPERSEDED — artifact not locatable in repo history, see below)
COSMO SLATE      | brave-lamport-qne0q0         | (head)   | 1/1   | READY  | 7     | +1051  | COSMO® SLATE v1 — 2-piece stainless steel pager, BOM, PCBWay mfg plan, firmware/software docs, PDF manual
