...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-hj9s7a      | (head)   | 1/1   | READY  | 9     | +326   | LOT Mail v1 — rebuilt fresh on current master: /email trigger, Sync Mail tab, SSE delivery, Cohort ✉ Mail button. Supersedes stale f6bw7r/eRBVA attempts.
