...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-4ayxl4     | 2ecc618c | 12/12 | READY  | 12    | +554   | GREEN-gated 20260704: /email trigger, Sync Chat|Mail tabs, Cohort mail button. Rebased onto current master + conflicts resolved. Awaiting Ship Mode merge to master (see LOT-SR-20260704-01).
