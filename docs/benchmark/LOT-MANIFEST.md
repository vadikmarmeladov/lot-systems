...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-9x0iz0     | d3f1ed33 | 1/1   | BEST   | 7     | +308   | In-app email: /email trigger, Sync inbox, Cohort integration, 2 bugfixes
...
determined-turing| 7     | 9x0iz0            | 6     | LOT Mail iterations (f6bw7r no longer on remote; 9x0iz0 is the new BEST — 2026-08-23)
