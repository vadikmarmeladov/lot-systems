...
COSMO Hardware   | claude/brave-lamport-y77uha  | 98971f2  | 1/1   | READY  | 14    | +1934  | SUPERSEDES brave-lamport-t9z5u8 (branch gone, content unrecoverable). COSMO® Computer v1.0 — plan, BOM+links, roadmap, firmware+software specs, 4 PDF manuals (LOT-SR-20260805-02)
