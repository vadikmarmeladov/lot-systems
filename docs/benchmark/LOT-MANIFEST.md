...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-uau32e     | (see SR-20260705-01) | 1/1 | STAGED | 12 | +554 | SHIPPED to ship branch 2026-07-05 (SR-20260705-01); PR to master pending — session was branch-restricted, could not push master directly
