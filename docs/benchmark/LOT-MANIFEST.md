...
Basics Tab       | beautiful-johnson-c4imn2      | 57625e70 | 1/1   | BEST   | 6     | +410   | BASICS M1 (rebuilt on current master) — true public /basics (no login), in-app SPA tab, 23-item ration ledger, doctrine, price line, status line. Supersedes beautiful-johnson-56p7ov/6815f550 (stale, ~150K lines behind master; Basics was login-gated only, never actually public — doctrine violation fixed here).
