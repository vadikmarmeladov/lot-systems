...
Basics Tab       | beautiful-johnson-nb2ocp      | bb9c9422 | 2/2   | BEST   | 9     | +868   | BASICS M1+M2: OPEN TAB + UPGRADE/STAND DOWN state machine, roster intake, Job 45 (supersedes 56p7ov — M1 landed forward onto current master, M2 added)
...
beautiful-johnson| 38+   | nb2ocp            | 37+   | Basics Tab iterations (latest: nb2ocp, M1+M2 — cluster has grown well
                 |       |                   |       | past the 2026-06-27 audit count; a fresh prune pass is due)
