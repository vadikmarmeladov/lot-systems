...
COSMO Hardware   | brave-lamport-xtfzf4         | (head)   | 6/6   | BEST   | 8     | +~1900 | COSMO® Cube v1.0 RECONSTRUCTED — t9z5u8/c7d353ef unreachable (pruned); fresh plan+BOM+firmware+software+PDF manual, docs/corporate/LOT-COSMO-CUBE-HARDWARE-v1.md
...
brave-lamport    | 6     | xtfzf4            | 5     | COSMO hardware iterations (latest series — t9z5u8 unreachable, reconstructed on xtfzf4 2026-09-04)
