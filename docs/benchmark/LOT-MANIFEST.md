...
Basics Tab       | beautiful-johnson-50hybx      | 931da836| 9/9   | BEST   | 9     | +613   | BASICS M1+M2: OPEN TAB + UPGRADE state machine, roster intake, self-service STAND DOWN. M3 (fulfillment) pending S-2 supplier decision.
