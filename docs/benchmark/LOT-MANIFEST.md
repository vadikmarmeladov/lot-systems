...
COSMO Hardware   | brave-lamport-9a42xc         | 001d1bb  | 1/1   | BEST   | 5     | +888   | COSMO® Computer — pager-class hardware computer v1 (plan+BOM+roadmap; supersedes dead brave-lamport-t9z5u8, content not recoverable)
...
brave-lamport    | 6     | 9a42xc            | 5     | COSMO hardware iterations (t9z5u8 series pruned/dead; 9a42xc is the current restart)
