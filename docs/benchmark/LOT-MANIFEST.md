...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-7ai03z      | (pending)| 1/1   | READY  | 2     | +68    | REBUILT 2026-08-08 (prior branch determined-turing-f6bw7r no longer exists on remote; the +504-line SR-20260605/06/12 design was never merged). New iteration: /email to [Name] Log slash command, recipient resolved via Cohort matches, delivered through existing POST /direct-messages (Sync). Zero new tables/routes/SSE events — see LOT-DOCTRINE.md Command-Triggered Endpoint Reuse, SR-20260808-01.
...
relaxed-hamilton | 8     | eRBVA             | 8     | LOT Mail iterations — branch pruned from remote, design superseded (never merged; see SR-20260808-01)
determined-turing| 1     | 7ai03z            | 0     | LOT Mail rebuilt 2026-08-08 (prior f6bw7r series pruned from remote — this is a fresh series, current branch is BEST/only iteration)
...
CURRENT SHIP QUEUE (BEST, awaiting Sunday merge):
  LOT Mail         | determined-turing-7ai03z  | +68 lines   (rebuilt 2026-08-08, see §01)
