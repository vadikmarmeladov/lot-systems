...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-p4nx5a     | f502746b | 12/12 | BEST   | 12    | +554   | In-app email: /email trigger, Sync inbox, Cohort integration; green-gated 20260831 (LOT-SR-20260831-01), master merge still pending
...
CURRENT SHIP QUEUE (BEST, awaiting Sunday merge):
  LOT Mail         | determined-turing-p4nx5a  | +554 lines (green-gated, was f6bw7r)
