...
Basics Tab       | claude/beautiful-johnson-9gjia4| aa092e71| 1/1   | BEST   | 4     | +502   | LOT-FM-001 Month 1: OPEN TAB live — 23-item ration ledger, doctrine, status line, price line. SR-20260707-01. Awaiting Ship Mode pass to master. (Prior entry for branch `beautiful-johnson-56p7ov` was stale — that branch does not exist on the remote; no such build ever actually shipped. Corrected here.)
