...
Basics Tab       | beautiful-johnson-yvoyz5      | 388ebb85 | -     | READY  | 4     | +199   | BASICS M1: OPEN TAB live — 23-item ration ledger, doctrine, status line. VERIFIED 20260830: 55 beautiful-johnson-* branches exist on remote (not the 2 this row previously implied), all independently reimplementing this same Month-1 scope, ZERO PRs ever opened, NONE merged to master. This row now points at the branch reconciled in SR-20260830-01 (cherry-picked cleanest prior attempt, re-green-gated) — pending S-2 decision to open a PR. Do not spawn another branch for this feature; see LOT-DOCTRINE Prior-Art Check.
