...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-j6cyzr     | (pending)| 1/1   | BEST   | 13    | +~560  | In-app email: /email trigger, Sync Mail tab, Cohort integration — ported 20260827 from stale f6bw7r onto current HEAD, goTo routing bug fixed, GREEN build
...
CURRENT SHIP QUEUE (BEST, awaiting Sunday merge):
  LOT Mail         | determined-turing-j6cyzr  | +~560 lines (GREEN, this branch, 20260827)
