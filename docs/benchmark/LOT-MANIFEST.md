...
Basics Tab       | beautiful-johnson-qbpx4z      | (head)   | 1/1   | BEST   | 11    | +~700  | BASICS M1: OPEN TAB live — 23-item ration ledger, /basics tab + /open-tab, doctrine, price+status line, M2/3 roadmap. Prior 56p7ov branch pruned before merge — rebuilt from scratch this session.
...
beautiful-johnson| 1     | qbpx4z            | 0     | Basics Tab — prior 56p7ov branch pruned/unreachable before merge; qbpx4z is a from-scratch rebuild, not a cherry-pick of the old iteration
