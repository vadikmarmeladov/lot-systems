...
COSMO Hardware   | brave-lamport-6vmmh7         | (head)   | 1/1   | BEST   | 3     | +520   | COSMO® Cube v2.0 — full build spec: BOM+links, PCBWay mfg plan, LOT API connector, 100-unit pilot roadmap
