...
──────────────     ─────────────────────────────   ────────   ─────   ──────   ─────   ──────   ──────────────────────
LOT Mail         | determined-turing-x7ythk     | acc534a9 | 12/12 | SHIPPED| 12    | +554   | SR-20260726-01: /email\/mail trigger, Sync Chat\|Mail tabs, EmailInbox, Cohort Mail action — cherry-picked from f6bw7r onto current baseline
