...
COSMO Hardware   | brave-lamport-y4bu4n          | (head)   | 2/2   | READY  | 10    | +2610  | COSMO® Cube v1.0 (7 docs, ported from orphaned brave-lamport-t9z5u8) + v2.0 session report, naming disambiguation vs CUBIQ, first PDF manual
