...
Basics Tab       | beautiful-johnson-8e7eak      | (head)   | 9/9   | BEST   | 11    | +833   | BASICS M1+M2: M1 ported onto current master (post-TabPanels refactor) + M2 upgrade state machine, roster intake, stand-down, issue log
...
beautiful-johnson| 50    | 8e7eak            | 49    | Basics Tab iterations (latest series — M1 ported + M2 built)
...
CURRENT SHIP QUEUE (BEST, awaiting Sunday merge):
  ...
  Basics Tab       | beautiful-johnson-8e7eak   | +833 lines
