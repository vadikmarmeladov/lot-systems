...
Basics Tab       | beautiful-johnson-k91wjf      | (pending)| 1/1  | BEST   | 11    | +562   | BASICS M2: UPGRADE+ROSTER state machine on top of M1 (ported forward from stale beautiful-johnson-56p7ov, never merged — see LOT-SR-20260819-01)
...
beautiful-johnson| 44    | k91wjf            | 43    | Basics Tab iterations — LOT-FM-001 fired repeatedly without ever
                 |       |                   |       | landing on master (2026-08-19 audit); 56p7ov (old M1 BEST) now
                 |       |                   |       | SUPERSEDED by k91wjf (M1 ported forward + M2 built, see LOT-SR-
                 |       |                   |       | 20260819-01); remaining ~42 presumed dead starts, needs S-2 review
