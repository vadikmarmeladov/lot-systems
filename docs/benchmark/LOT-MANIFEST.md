...
Basics Tab       | beautiful-johnson-2sinrr      | fced03f8 | 1/1   | BEST   | 16    | +~950  | BASICS M1+M2+M3: public OPEN TAB, roster state machine (PENDING/ON_STRENGTH/STEADY_STATE), COGS-gated issue engine, STAND DOWN. Supersedes 56p7ov (stale, disjoint history, never merged, M1-only).
...
CURRENT SHIP QUEUE (BEST, awaiting Sunday merge):
  ...
  Basics Tab       | beautiful-johnson-2sinrr   | +~950 lines (supersedes 56p7ov, never merged)
