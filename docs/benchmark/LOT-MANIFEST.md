...
Basics Tab       | beautiful-johnson-ahuh1t      | (pending) | 1/1 | BEST   | 13    | +664   | BASICS M1+M2: public OPEN TAB (/open-tab, no-auth) + UPGRADE/ROSTER state machine (USERSHIP→PENDING→ON STRENGTH, STAND DOWN); supersedes beautiful-johnson-56p7ov (M1 never actually public — app.tsx redirects anonymous visitors before any tab renders)
