...
COSMO Hardware   | brave-lamport-9a42xc         | (pending)| 1/1   | BEST   | 5     | +888   | COSMO® Computer — pager-class hardware computer v1 (plan+BOM+roadmap; supersedes dead brave-lamport-t9z5u8, content not recoverable)
