...
COSMO Hardware   | brave-lamport-t9z5u8         | c7d353ef | 14/14 | SUPERSEDED | 7 | +2610  | COSMO® Cube — complete hardware computer design v1.0 (branch pruned; see below)
COSMO Computer   | brave-lamport-xdjrxx          | (head)   | 1/1   | DRAFT  | 6     | +827   | Hardware plan, BOM, firmware spec, software spec, PDF manual — Phase 0 planning, no hardware ordered
