...
Basics Tab       | beautiful-johnson-5nragc      | (pending)| 1/3   | BEST   | 6     | +371   | REBUILD M1/3: prior beautiful-johnson-56p7ov branch pruned before this checkout, code lost; LOT-FM-001 manual authored fresh + M1 (OPEN TAB — 23-item ration ledger, doctrine, status line) rebuilt from spec
