...
COSMO Hardware   | brave-lamport-t9z5u8         | c7d353ef | 14/14 | SUPERSEDED | 7 | +2610  | COSMO® Cube v1.0 — content lost to a prior merge; no surviving file. Superseded by COSMO Node row below (2026-08-15).
COSMO Node       | brave-lamport-6b5u13         | (session) | 1/1 | DRAFT  | 3     | +~450  | COSMO® Node v1.0 — hardware/BOM/roadmap spec recovering the above line item under a new name; docs/corporate/LOT-COSMO-NODE-v1.md; firmware + software docs NOT yet written (see doc §11)
