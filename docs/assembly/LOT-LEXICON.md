...
Migrated forward from `docs/benchmark/LOT-LEXICON.md` (superseded location,
last touched 2026-07-19 — session bookkeeping moved to `docs/assembly/` /
`docs/LOT-SR-*.md` after that date). The source file is left untouched as the
verbatim historical record; this file is now the live vocabulary going
forward. (LOT-SR-20260727-01.)
...
## Candidates under evaluation (below minting threshold)

```
TOKEN              MEANING                                                    APPEARANCES  SINCE
──────────────     ──────────────────────────────────────────────────────      ───────────  ──────────
QI·46              Ratified engine name — see docs/corporate/LOT_QI46_ENGINE.md 1            20260727
SOUL UPLOAD         Public name for Calibration Loop deliberate/passive intake  1            20260727
BEING CALIBRATION   Public name for Response Grammar (Layer 3) persona tuning   1            20260727
```
