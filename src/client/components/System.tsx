...
export const System = React.memo(function SystemInner() {
  ...
  // render-phase-write hazard as quantumState in MemoryWidget; it must not run
  // during render (including the initial one) or it re-triggers the atom-write
  // render cascade on logs change.
