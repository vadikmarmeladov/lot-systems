...
export const System = React.memo(function SystemInner() {
  ...
  // timeZone (profile setting) when set, so a device set to a different
  // timeZone than the user's home base still shows their local reading —
  // falls back to device-local time otherwise, same as before.
