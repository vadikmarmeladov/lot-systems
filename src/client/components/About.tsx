    ...
    <div className="min-h-screen bg-bac text-acc">
      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <Row label="QIE pattern library:" value="152 patterns active" />
...
Ecosystem Synchrony signal: ecosystem_full_sync (all 5 nodes)`}</CodeBlock>
          ...
          <SubHeading>Personalization &amp; Synchronization</SubHeading>
          <P>
            Ambient, not natal — the reading is built entirely from date/time
            math (zodiac hour, rokuyo, moon phase) plus the viewer{'’'}s own
            clock and, on the server, their saved timeZone. No birth date,
            birth time, or birth place is collected or required.
          </P>
          <div className="mb-16">
            <Row label="dashboard refresh" value="every 15 min while tab visible, paused when hidden" />
            <Row label="Logs sync" value="every log entry snapshots the reading (context.astro*), timeZone-aware" />
            <Row label="QIE signal" value="'astrology' Tier 0 source — one ambient_reading signal per calendar day" />
            <Row label="QIE dependents" value="system, cosmic, goals widgets read the astrology node" />
            <Row label="P152 auspicious-goal-alignment" value="Taian day + active goals/intentions same day → passive nudge, conf 0.58–0.75" />
          </div>
