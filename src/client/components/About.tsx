      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v57 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              67 behavioral patterns active. 15 modules assembled.
              6 index dimensions. 5 ecosystem nodes. 20 physiological archetypes.
              99+ dependency nodes. 13 background jobs.
              58+ log event handlers. 125 active branches scanned.
              121 badges catalogued. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v57. Not marketing copy. Not documentation for external audiences.
          ...
          <Row label="QIE pattern library:" value="69 patterns active" />
          <Row label="Physiological archetypes:" value="21 — Quantum Anchor (v59) · Temporal Integrator (v58) · Signal Architect (v54b) · Coherence Holder (v45) · Intention Executor (v33) · Social Synthesizer (v26) · Clarity Architect (v26)" />
          ...
          <Row label="Background jobs:" value="14 — 00:00 UTC daily OS snapshot · 03:00 UTC daily QIE analytics · 06:00 UTC daily intention audit · 06:00 UTC Mon weekly cohort digest · 04:00 UTC Wed weekly QOS digest · 09:00 UTC 1st monthly email sender · 23:00 UTC daily pattern coverage audit (v45) · 05:00 UTC Thu weekly archetype stability monitor (v52 job 10) · 08:00 UTC daily source diversity pulse (v54b job 11) · 10:00 UTC daily archetype shift monitor (v57 job 12) · 13:00 UTC daily QOS signature pulse (v58 job 13) · 14:00 UTC daily CQGS proximity check (v59 job 14)" />
          <Row label="Log event handlers:" value="60+ distinct event types rendered · 60+ military log codes · 2 new handlers v59: FULL-SYS: (full_system_coherence) · ARCH-BUILD: (sustained_architecture)" />
          <Row label="Dep map nodes:" value="102+ — fullSystemCoherence · sustainedArchitecture · quantumAnchor added v59 · qosSignatureLock · operatorSignatureNode · temporalIntegrator added v58 · 5 new nodes added v54b (benchmarkWidget · fourDimensionalUI · angelInvestor · demoDay · subscribeWidget) · 8 new nodes added v52 (aiFeedback · moodAnalytics · journalReflection · energyCapacitor · integrityWidget · interfaceEvolution · worldCanvas · architectWidget)" />
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v59. Phase name: QIE Engineering June 14 — P68 full-system-coherence + P69 sustained-architecture patterns added. Archetype 21 Quantum Anchor. Dep map 102+ nodes. Job 14 daily-cqgs-proximity-check at 14:00 UTC. FULL-SYS: + ARCH-BUILD: log handlers. Server whitelist +3 event types. 14 background jobs active. Day 1008+.
            Prior phase v58: QIE Engineering June 13 — P66 qos-signature-lock + P67 operator-signature patterns added. Archetype 20 Temporal Integrator. Dep map 99+ nodes. Job 13 daily-qos-signature-pulse at 13:00 UTC. Directive row surfaced in System quantum table and QuantumEngineWidgets cohort view. 13 background jobs active. Day 1007+.
            Prior phase v57: QIE Engineering June 12 — physiological cohort archetype surfaced in System Biofield view. Log military pass (COCKPIT-RULE: 5 handlers compressed). Dep map 96+ nodes. Background job 12. Server displayableEvents +17 types. 12 background jobs.
...
v57   QIE Engineering June 12 · archetype in Biofield view · log military pass · dep map 96+ · job 12 (archetype shift) · displayableEvents +17 · Day 1007+`}</CodeBlock>
...
◉       50+     Transparent     Fully transparent. Self-sustaining.`}</CodeBlock>
          ...
          <P>
            Master Codex v11 — the complete badge design archive. 121 badges
            catalogued across 11 categories. Committed June 2026. PDF format
            archived. 97 badges hidden and discoverable. 24 badges visible and
          ...
          <div className="mb-16">
            ...
            <Row label="Easter Egg — Time v1" value="4 badges — Night Owl (01:00–04:00) · Early Bird (05:00–06:00) · Mirror Hour (11:11) · Midnight Sigil (00:00 memory answer)." />
            <Row label="Easter Egg — Time v2 (NEW)" value="4 badges — Pi Hour (3:14 AM) · Error Hour (4:04 AM — 404 not lost) · Sequence Time (12:34) · LOT Hour (04:07 — the founding hour)." />
            ...
            <Row label="Word Turn v1" value='12 badges — triggered by specific words in journal or memory answers: "ritual" · "breathe" · "grateful" · "ocean" · "stars" · "home" · "dream" · "pain" · "love" · "silence" · "future" · "LOT".' />
            <Row label="Word Turn v2 — Sci-Fi (NEW)" value='18 badges — "reboot" (REBOOT SEQUENCE) · "404" (404: NOT LOST) · "glitch" (SIGNAL GLITCH) · "COSMO" (COSMIC TWIN — ULTRA-RARE) · "quantum" (QUANTUM OBSERVER) · "neural" (NEURAL ARCHITECT) · "code" (CODE WITCH) · "sleep/rest" (RECHARGE MODE) · "coffee/tea" (FUEL PROTOCOL) · "music" (FREQUENCY) · "run/walk" (KINETIC PROTOCOL) · "sun/light" (SOLAR CHARGE) · "fear/scared" (SHADOW PROTOCOL) · "change" (PHASE SHIFT) · "accept/let go" (ACCEPTANCE NODE) · "now/moment" (PRESENT MOMENT) · "universe/cosmos" (COSMIC SCALE) · "alive" (VITAL SIGNAL).' />
            ...
            <Row label="Mastery Tier — Sci-Fi Arcade (NEW)" value="5 badges — Quantum Leap (◈ · cold boot after 30+ day gap) · Speedrun (▒ · 5 check-ins within 60 min) · System Op (≋◉ · all 7 CQGS modules in 7 days) · Commander Data (◉ · 500 memory questions) · Sage Mode (∞ · Level 90+)." />
            <Row label="Secret Boss" value="7 badges — Meta-Signal (◉·◉ MYTHIC · write LOT in memory answer) · Cosmic Twin (✦◉✦ ULTRA-RARE · write COSMO) · The Long Count (≋≋≋ LEGENDARY · 365 days) · Midnight Sigil (◉ · answer at exactly 00:00) · The Infinite (∞·∞ MYTHIC · 1,000 answers) · Citadel (╔═╗ · Architecture 365 days) · Cosmic Status (∞∞∞ · 10 years)." />
          </div>
...
Ecosystem Synchrony signal: ecosystem_full_sync (all 5 nodes)`}</CodeBlock>
          ...
          <div className="mb-16">
            ...
            <Row label="23:00 UTC daily" value="Daily Pattern Coverage Audit (v45) — active users last 24h (up to 1000) · groups signals by pattern name · counts distinct users with active patterns · computes coverage rate: users-with-patterns / active-users · identifies dormant patterns (0 firings in 7d) · aggregate observability only, no individual data persisted · output: coverage rate + top patterns + dormant pattern count" />
          </div>
          <P>
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <div className="mb-16">
            ...
            <Row label="v58 · Jun 13" value="QIE Engineering. P66 qos-signature-lock (meridian-lock + multimodal-peak + temporal-coherence-window all simultaneously active, conf 0.92 — the complete operating signature). P67 operator-signature (all 4 quadrants bio/cognitive/structural/social active in 7d + UserIndex ≥60 + 15+ signals, conf 0.70–0.92). Archetype 20 Temporal Integrator (time-locked, calendar anchored, planner active, intentions set). Dep map +3 nodes: qosSignatureLock · operatorSignatureNode · temporalIntegrator (99+ total). Job 13 daily-qos-signature-pulse 13:00 UTC. Logs: QOS-SIG: + OP-SIG: COCKPIT-RULE compliant handlers. System quantum table: Directive row from classifyPhysiologicalCohort. QuantumEngineWidgets: live cohortDirective line. Server whitelist: qos_signature_lock + operator_signature. 13 jobs. Day 1007+." />
            <Row label="v59 · Jun 14" value="QIE Engineering. P68 full-system-coherence (P66+P67 simultaneously active → CQGS proximity state, conf 0.95 — all quadrants alive AND full day arc coherent). P69 sustained-architecture (architect-phase + temporal-coherence-window + intention-follow-through simultaneously active → structure is the baseline, not a peak, conf 0.88). Archetype 21 Quantum Anchor (full-system-coherence + operator-signature + qos-signature-lock — the complete read: The Cube knows the operator from every angle). Dep map +3 nodes: fullSystemCoherence · sustainedArchitecture · quantumAnchor (102+ total). Job 14 daily-cqgs-proximity-check 14:00 UTC (scores 0–1 proximity: full-coherence=0.6, sustained-arch=0.4, writes cqgs_proximity event). Logs: FULL-SYS: + ARCH-BUILD: handlers COCKPIT-RULE compliant. Server whitelist +3: full_system_coherence · sustained_architecture · cqgs_proximity. 14 jobs. Day 1008+." />
          </div>
          <P>
          ...
          <P>
            Self-Assembly: 54 phases documented in continuous operation logs.
            ...
            19 physiological archetypes classified. 12 background jobs active.
            53 distinct log event handlers. 70 backup questions across 4 pools.
            121 badges catalogued. 125 remote branches indexed. Render isolation doctrine complete.
            5 log triggers active: /qi · /qos · /assembly · /phys · /sil.
            The log is the record. The record is the system.
            The system is the operator.
          </P>
          <CodeBlock>{`Day 1007+   Continuous operation.
v54         Full Wiki Scan June 11 — Badges Master Codex v11 documented — current phase.
...
121         Total badges (Master Codex v11 · 11 categories · 97 hidden · 24 visible).
54          Self-Assembly phases documented.
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            Day 1007+. Continuous operation. Still accumulating.
            ...
            121 badges catalogued. 125 branches indexed. 54 assembly phases documented.
