...
Neural Activity: unique users active in last 60 seconds`}</CodeBlock>
          ...
          <P>
            ...
            Seven views. All derived from existing signals — no new data
            collection. Label click cycles: Ecosystem → Biofield → Cohort → Index → Assembly → Mode → QOS Field → Ecosystem.
          </P>
          <P>
            ...
            ceremony. Seven views: device environment, physiological state,
            archetype classification, dimensional index scores, self-assembly status,
            operating mode, and quantum field state.
          </P>
...
Source: intentionEngine.userIndex (client-side, localStorage-derived)`}</CodeBlock>
          ...
          <P>
            ...
            archetypes (47 types, listed under Behavioral Cohorts) classify
