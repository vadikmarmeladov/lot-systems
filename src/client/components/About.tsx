      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v72 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              Field Manual v72. Not marketing copy. Not documentation for external audiences.
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            ...
            72 iterations since continuous operation began.
...
v72         QIE Engineering June 25 — P.84/85/86 · Archetype 29 Peak Strategist · COCKPIT-RULE pass · dep map 126+ nodes — current phase.
