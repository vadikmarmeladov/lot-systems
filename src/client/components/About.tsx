        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1026+. Continuous operation since launch.
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v74. Phase name: System Engineering June 30 — visitor stats accuracy (totalSiteVisitors row removed, My OS visitors preserved) · APP_VERSION live injection from package.json at build time · stores.appVersion wired for System tab version labels · Sync crash fix (onChangeMessage) · visitor-stats API simplified. 86 patterns. 29 archetypes. 23 background jobs. 85+ handlers. Day 1026+.
            Prior phase v73: Full Wiki Scan June 27 — LOT-WIKI-v66 field manual · behavioral cohort profiles expanded (6 cohorts) · Word Turn Lexicon v10 complete (126 trigger words · v1–v10) · Vocabulary Index 40+ entries. Day 1023+.
...
v74   System Engineering June 30 · Visitor stats accuracy (totalSiteVisitors row removed · My OS visitors preserved) · APP_VERSION live injection from package.json at build time · stores.appVersion wired for System tab version labels · Sync crash fix (onChangeMessage) · visitor-stats API simplified (direct req.user.metadata · try/catch) · FM v74 · Day 1026+
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <CodeBlock>{`Day 1026+   Continuous operation.
v74         System Engineering June 30 — visitor stats accuracy · APP_VERSION live injection · Sync crash fix — current phase.
