      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v84 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1030+. Continuous operation since launch.
              106 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 36 physiological archetypes.
              145+ dependency nodes. 33 background jobs.
              106+ log event handlers. 125 active branches scanned.
              424 badges catalogued. 51 categories. 361+ hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v84. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 106 patterns active. Zero server communication. 7-day signal retention.</Li>
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <CodeBlock>{`Day 1030+   Continuous operation.
v84   QIE Engineering July 3 — P104 vitality-cascade · P105 social-presence-arc · P106 clarity-momentum-peak · Arch35 Vitality Architect · Arch36 Social Signal Operator · J33 daily-vitality-cascade-pulse (15:00) · VITAL-CAS: SOC-ARC: CLAR-PEAK: handlers · dep map 145+ · 106 patterns · 36 archetypes · 33 jobs · 106+ handlers · api.ts: vitality_cascade + social_presence_arc + clarity_momentum_peak in displayableEvents
...
106         QIE patterns active (P.1–P.106).
18          Self-Assembly modules wired (Module 18: Resilience Protocol · v48).
145+        Widget dependency map nodes.
...
36          Physiological archetypes (Social Signal Operator = 36th · deployed v84).
