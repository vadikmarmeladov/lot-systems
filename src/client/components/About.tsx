      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v74 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              90 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 30 physiological archetypes.
              130+ dependency nodes. 25 background jobs.
              88+ log event handlers. 125 active branches scanned.
              389 badges catalogued. 50 categories. 326 hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v74. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 90 patterns active. Zero server communication. 7-day signal retention.</Li>
          ...
          <Row label="Background jobs:" value="25 — 00:00 UTC daily OS snapshot · 03:00 UTC daily QIE analytics · 06:00 UTC daily intention audit · 06:00 UTC Mon weekly cohort digest · 06:00 UTC Sun weekly cognitive depth check (v68 job 20 — COGN: COGNITIVE DEPTH ARC · cognitive_depth_arc event) · 04:00 UTC Wed weekly QOS digest · 07:00 UTC daily source diversity pulse · 08:00 UTC morning biofield summary · 09:00 UTC 1st monthly email sender · 09:00 UTC Mon weekly longitudinal drift check (v71 job 22 — DRIFT: · longitudinal_drift · 28d arc) · 09:00 UTC Tue weekly badge progress scan (v64 job 16 — BADGE-SCAN: UNLOCKS:/7D · TYPES: · MOMENTUM:) · 10:00 UTC daily archetype shift monitor · 11:00 UTC daily morning intention launch (v65 job 17 — MCL: MORNING LAUNCH · morning_coherence_launch event) · 11:00 UTC Fri weekly LOT AI story generator (job 24) · 12:00 UTC daily vitality peak check (v69 job 21 — VITAL: CIRCADIAN VITALITY PEAK · vitality_peak event · morning mood + energy + biorhythm) · 13:00 UTC daily QOS signature pulse · 14:00 UTC daily QOS mode watch (v71 job 23 — OS [MODE]: · qos_mode_change on transition) · 15:00 UTC Sun weekly QOS convergence audit (v62 job 15) · 16:00 UTC daily coherence index pulse · 20:00 UTC daily signal momentum check (v67 job 19 — MOM: MOMENTUM LOCK · signal_momentum event) · 20:00 UTC Sun weekly intention completion audit · 21:00 UTC daily restoration arc check (v74 job 25 — RESTORE: · restoration_arc · depletion+3+ care+energy improved) · 22:00 UTC daily evening coherence close (v66 job 18 — EVE: EVENING CLOSE · evening_coherence_close event) · 23:00 UTC daily pattern coverage audit · 05:00 UTC Thu weekly archetype stability monitor" />
          <Row label="Log event handlers:" value="88+ distinct event types rendered · military log codes · v74: RESTORE: (restoration_arc: PRIOR ATP·CARE OPS·WINDOW) · CIRC-ARC: (circadian_coherence: PHASES·COVERAGE·WINDOW) · MEM-BRIDGE: (memory_intention_bridge: FLOW memory→intention·INTERVAL) · v72: ADAPT-MOM: (adaptive_momentum: STREAK·STRUCT) · VSTRAT: (vitality_strategy_peak: MORNING MOOD·STRUCT DEPTH·HOUR) · v68: COGN: (cognitive_depth_arc: COGNITIVE DEPTH ARC·MEM 7D:·WORDS:·BADGES:·Deep trace confirmed) · v67: MOM: (signal_momentum: MOMENTUM LOCK·DAYS 7D:·SRC:) · v66: EVE: (evening_coherence_close: EVENING CLOSE·Arc confirmed·CAPTURE: n channel(s)) · v65: MCL: (morning_coherence_launch: MORNING LAUNCH·intent·+min) · VAULT: (signal_vault: DEPTH·wordcount·SRC·n/3) · SURGE: (depletion_recovery_surge: state→HIGH·CARE 6H:) · v64: BADGE: (badge_unlock: symbol·name·CAT:) · BADGE-SCAN: (badge_progress_scan: UNLOCKS:/7D·TYPES:·MOMENTUM:) · v62: CRYSTAL: (signal_crystallization) · BIO-LOCK: (biorhythm_lock) · PEAK-SUMMIT: (quantum_coherence_summit) · CONV-AUDIT: (convergence_audit)" />
          <Row label="Dep map nodes:" value="130+ — restorationArcNode · circadianCoherenceNode · memoryIntentionBridgeNode · depthDiversityNode added v74 · longitudinalDriftMonitor · qosModeWatcher · adaptiveMomentumNode · vitalityStrategyNode added v72 · vitalityMonitor · systemicThinker added v69 · INTENT [VEL] · SIG [BURST] · QIE [PAT] nodes added v45 · coherenceHolder dep node added · crystallizationArc · vitalConvergence added v39 · 8 new nodes added v52 (aiFeedback · moodAnalytics · journalReflection · energyCapacitor · integrityWidget · interfaceEvolution · worldCanvas · architectWidget) · 5 new nodes added v54b (benchmarkWidget · fourDimensionalUI · angelInvestor · demoDay · subscribeWidget) · 5 new nodes added v65 (publicProfile · plannerWidget · moodMomentum · breatheMonitor · fastingSignal)" />
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v74. Phase name: QIE Engineering June 28 — P.87 circadian-coherence-arc · P.88 memory-intention-bridge · P.89 restoration-acceleration · P.90 depth-diversity-convergence · Archetype 30 Restorative Architect · Job 25 daily-restoration-arc-check 21:00 UTC · dep map 130+ nodes · RESTORE: CIRC-ARC: MEM-BRIDGE: handlers. 90 patterns. 30 archetypes. 25 background jobs. 88+ handlers. Day 1024+.
            ...
            74 iterations since continuous operation began.
...
v74   QIE Engineering June 28 · P.87 circadian-coherence-arc (3+ circadian phases same day, conf 0.65–0.88) · P.88 memory-intention-bridge (memory→intention 2h, conf 0.72) · P.89 restoration-acceleration (depletion+3+ care+energy recovered 24h, conf 0.70–0.90) · P.90 depth-diversity-convergence (journal >100w+memory+3+ sources, conf 0.68–0.88) · Archetype 30 Restorative Architect (selfcare+mood+energy · restoration arc confirmed) · Job 25 daily-restoration-arc-check 21:00 UTC · RESTORE: CIRC-ARC: MEM-BRIDGE: handlers · dep map 130+ nodes · 90 patterns · 30 archetypes · 25 jobs · 88+ handlers · Day 1024+`}</CodeBlock>
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <CodeBlock>{`Day 1023+   Continuous operation.
v73         Full Wiki Scan June 27 — LOT-WIKI-v66 · cohort profiles · Word Turn Lexicon v10 · Vocabulary Index 40+ — current phase.
