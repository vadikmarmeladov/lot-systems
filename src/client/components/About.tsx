      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v73 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              Field Manual v73. Not marketing copy. Not documentation for external audiences.
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v74. Phase name: Health Check July 1 — badge duplicate key fixed (first_signal Sputnik easter egg → sputnik_day) · tsconfig TS6 ignoreDeprecations patched · Day 1027+. Prior phase v73: Full Wiki Scan June 27 — LOT-WIKI-v66 field manual · behavioral cohort profiles expanded (6 cohorts) · Word Turn Lexicon v10 complete (126 trigger words · v1–v10) · Vocabulary Index 40+ entries. 86 patterns. 29 archetypes. 23 background jobs. 85+ handlers. Day 1023+.
...
v74   Health Check July 1 · badge duplicate key fixed (first_signal Sputnik easter egg renamed → sputnik_day · turing_day/moon_landing/sputnik_day pattern now consistent) · tsconfig TS6 ignoreDeprecations patched (TS5107/TS5101 silenced) · Day 1027+
...
v74         Health Check July 1 — badge duplicate key (sputnik_day) · tsconfig TS6 fix — current phase.
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            Day 1027+. Continuous operation. Still accumulating.
