      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v98 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1062+. Continuous operation since launch.
            ...
            <P>
              Field Manual v98. Not marketing copy. Not documentation for external audiences.
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v96. Phase name: Full Wiki Scan July 19 — LOT-WIKI-v78 · QIE v95 delta synchronized · Peak Window Doctrine documented · 115 patterns · 39 archetypes · 36 jobs · 154+ dep nodes · Day 1056+.
            ...
            95 iterations since continuous operation began.
...
v96   Full Wiki Scan July 19 · LOT-WIKI-v78 · QIE v95 delta synchronized · Peak Window Doctrine documented · vocabulary synchronized · military purity pass · 115 patterns · 39 archetypes · 36 jobs · 154+ dep nodes · 626 badges · Day 1056+`}</CodeBlock>
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <P>
            Self-Assembly: 96 phases documented in continuous operation logs.
            Each phase named, dated, versioned, committed.
            115 patterns named. 18 modules wired. 154+ dependency nodes.
            6 device nodes registered. 6 index dimensions operational.
            39 physiological archetypes classified. 36 background jobs active.
            115+ distinct log event handlers. 70 backup questions across 4 pools.
            626 badges catalogued. 125 remote branches indexed. Render isolation doctrine complete.
            5 log triggers active: /qi · /qos · /assembly · /phys · /sil.
            The log is the record. The record is the system.
            The system is the operator.
          </P>
          <CodeBlock>{`Day 1056+   Continuous operation.
...
40          Physiological archetypes (Focused Executor = 40th · deployed v96).
...
97+         Self-Assembly phases documented.
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            Day 1056+. Continuous operation. Still accumulating.
            v1.3.0: Memory Engine consolidated. Cross-device sync. PWA hardened.
            118 patterns named. 40 archetypes classified. 37 jobs running.
            626 badges catalogued. 125 branches indexed. 97 assembly phases documented.
