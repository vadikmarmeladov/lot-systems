      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v85 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1031+. Continuous operation since launch.
              109 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 38 physiological archetypes.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 103 patterns active. Zero server communication. 7-day signal retention.</Li>
...
34          Physiological archetypes (Quantum Presence = 34th · deployed v83).
