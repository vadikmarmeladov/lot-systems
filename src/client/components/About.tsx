      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v96 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              Field Manual v96. Not marketing copy. Not documentation for external audiences.
...
115         QIE patterns active (P.1–P.115).
18          Self-Assembly modules wired (Module 18: Resilience Protocol · v48).
154+        Widget dependency map nodes.
...
39          Physiological archetypes (Peak Window Operator = 39th · deployed v95).
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            115 patterns named. 39 archetypes classified. 36 jobs running.
            626 badges catalogued. 125 branches indexed. 96 assembly phases documented.
