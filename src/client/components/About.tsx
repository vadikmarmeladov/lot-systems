        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1100+. Continuous operation since launch.
              ...
              812 badges catalogued. 22 Word Turn engines. 27 secret boss triggers. 270 word turns. The system does not sleep. It accumulates.
            </P>
            <P>
