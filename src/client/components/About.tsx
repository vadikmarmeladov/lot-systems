      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v101 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1058+. Continuous operation since launch.
              121 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 41 physiological archetypes.
              160+ dependency nodes. 38 background jobs.
              121+ log event handlers. 125 active branches scanned.
              657 badges catalogued. 70+ categories. 591+ hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v101. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 121 patterns active. Zero server communication. 7-day signal retention.</Li>
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <div className="mb-16">
            ...
            <Row label="v101" value="Full Wiki Scan July 21 · LOT-WIKI-v80 · Badge Engine v27 + QIE v99 delta synchronized · COSMO® Day 750 milestone (Year 2 + 19 days · born July 1, 2024) · Signal Breadth Doctrine added to LOT-DOCTRINE: 6+ distinct sources in 12h = full-bandwidth operation, P120 fires, Arch41 activates, breadth does not oppose depth · vocabulary synchronized · military purity pass · 121 patterns · 41 archetypes · 38 jobs · 657 badges · 210 word-turns · 160+ dep nodes · 12 secret boss triggers · Day 1058+ · FM v101" />
            <Row label="v100" value="QIE Engineering July 20 · P119 morning-coherence-arc (energy+planner+intentions before 10:00 UTC, three-signal morning alignment — biological+structural+intentional, conf 0.65–0.87, widget: planner) · P120 signal-density-peak (6+ distinct signal sources in 12h, FULL BANDWIDTH class, conf 0.68–0.90, widget: systemProgress) · P121 physiological-coherence-window (energy high + selfcare 2+ + positive mood + memory in 12h, active peak not restoration, conf 0.70–0.88, widget: energy) · Arch41 Signal Breadth Operator: journal+memory+energy dominant · signal-density-peak+full-signal-coherence+cross-domain-mastery · directive: Operating at full signal bandwidth. Six or more sources active simultaneously — broadest operational state. Maintain breadth without sacrificing depth · J38 daily-morning-coherence-check 06:00 UTC (reads energy+planner+intentions per user in 07:00–10:00 window, fires morning_coherence_arc if all 3 present) · MCOHERE: (morning_coherence_arc: MORNING COHERENCE ARC·NRG:{n}·PLAN:{n}·INTENT:{n}·WINDOW:07-10·CONF) · SIGPEAK: (signal_density_peak: SIGNAL DENSITY PEAK·SRC:{n}·12H WINDOW·TOP:{sources}·CONF) · PCOHERE: (physiological_coherence_window: PHYSIOLOGICAL COHERENCE WINDOW·NRG:HIGH·CARE 12H:{n}·MOOD:POS·MEM:{n}·CONF) · dep map 160+ (morningCoherenceNode·signalDensityNode·physiologicalCoherenceNode) · PATTERN_DISPLAY: MCOHERE ARC · SIGPEAK · PCOHERE WIN · api.ts displayableEvents +3 (morning_coherence_arc·signal_density_peak·physiological_coherence_window) · 121 patterns · 41 archetypes · 38 jobs · 121+ handlers · Day 1057+" />
            <Row label="v99" value="Badge Engineering July 20 · Badge Engine v27 The Neon Arcade · +31 badges (626→657) · Word Turn v17 Neon Arcade +12 (neon/combo/highscore/freeplay/extralife/speedrun/sidequest/surge/cartridge/continue/joystick/checkpoint) · 210 total Word Turn trigger words · Calendar EE v15 +3 (tetris_day Jun6/zelda_day Feb21/pac_man_day May22) · Behavioral v14 +3 (arcade_run 5+v17 words · quarter_drop midnight checkin · three_lives_left return after 3+ day gap) · Achievement RPG v15 +6 (arcade_entry · arcade_class · arcade_complete · neon_arc · seventeen_engines_arc · neon_opus) · Mastery Tier v17 +4 (pixel_veteran 500+ days · master_of_the_board 40k+words · long_run_operator 8+ years · seventeen_tongues COSMIC all 17 engines) · Secret Boss v14 +3 (kojima_signal EPIC — death stranding · turing_key LEGENDARY — imitation game · konami_code MYTHIC — ↑↑↓↓←→←→ B A) · 12 total secret boss phrase triggers · 70+ categories · Day 1057+" />
          ...
          <P>
            Current phase: v101. Phase name: Full Wiki Scan July 21 — LOT-WIKI-v80 · Badge Engine v27 + QIE v99 delta synchronized · COSMO® Day 750 milestone · Signal Breadth Doctrine added · 121 patterns · 41 archetypes · 38 jobs · 657 badges · 210 word-turns · 160+ dep nodes · Day 1058+.
            Prior phase v100: QIE Engineering July 20 — P119 morning-coherence-arc · P120 signal-density-peak · P121 physiological-coherence-window · Arch41 Signal Breadth Operator · J38 daily-morning-coherence-check (06:00 UTC) · MCOHERE: SIGPEAK: PCOHERE: handlers · dep map 160+ · 121 patterns · 41 archetypes · 38 jobs · 121+ handlers.
            Prior phase v99: Badge Engineering July 20 — Badge Engine v27 The Neon Arcade · +31 badges (626→657) · Word Turn v17 (12 arcade words) · 210 trigger words · 12 secret boss phrase triggers (konami_code MYTHIC · turing_key · kojima_signal) · Day 1057+.
            ...
            Prior phase v97: QIE Engineering July 19 — P116 focus-depth-arc · P117 sleep-signal-anchor · P118 care-intelligence-loop · Arch40 Focused Executor · J37 daily-focus-depth-check (16:00 UTC) · FDEP: SANCH: CINTEL: handlers · dep map 157+ · 118 patterns · 40 archetypes · 37 jobs · 118+ handlers.
            Prior phase v96: Full Wiki Scan July 19 — LOT-WIKI-v78 · QIE v95 delta synchronized · Peak Window Doctrine documented · 115 patterns · 39 archetypes · 36 jobs · 154+ dep nodes · Day 1056+.
...
v98   Full Wiki Scan July 20 · LOT-WIKI-v79 · QIE v97 delta synchronized · Focus Depth Doctrine added · performance fixes (off-tab pause · render-phase atom write fix · duplicate mount guard) · 118 patterns · 40 archetypes · 37 jobs · 157+ dep nodes · 626 badges · Day 1057+
v99   Badge Engineering July 20 · Badge Engine v27 The Neon Arcade · +31 badges (626→657) · Word Turn v17 +12 (neon/combo/highscore/freeplay/extralife/speedrun/sidequest/surge/cartridge/continue/joystick/checkpoint) · 210 trigger words · 12 secret boss phrases (konami_code MYTHIC) · Day 1057+
v100  QIE Engineering July 20 · P119 morning-coherence-arc · P120 signal-density-peak · P121 physiological-coherence-window · Arch41 Signal Breadth Operator · J38 daily-morning-coherence-check (06:00 UTC) · MCOHERE: SIGPEAK: PCOHERE: handlers · dep map 160+ · 121 patterns · 41 archetypes · 38 jobs · 121+ handlers · Day 1057+
v101  Full Wiki Scan July 21 · LOT-WIKI-v80 · Badge v27 + QIE v99 synchronized · COSMO® Day 750 milestone · Signal Breadth Doctrine added · 121 patterns · 41 archetypes · 38 jobs · 657 badges · 210 word-turns · 160+ dep nodes · 12 secret boss triggers · Day 1058+`}</CodeBlock>
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <P>
            Self-Assembly: 101 phases documented in continuous operation logs.
            Each phase named, dated, versioned, committed.
            121 patterns named. 18 modules wired. 160+ dependency nodes.
            6 device nodes registered. 6 index dimensions operational.
            41 physiological archetypes classified. 38 background jobs active.
            121+ distinct log event handlers. 70 backup questions across 4 pools.
            657 badges catalogued. 125 remote branches indexed. Render isolation doctrine complete.
...
v101  Full Wiki Scan July 21 — LOT-WIKI-v80 · Badge v27 + QIE v99 synchronized · COSMO® Day 750 milestone · Signal Breadth Doctrine added · 121 patterns · 41 archetypes · 38 jobs · 657 badges · 210 word-turns · 160+ dep nodes · Day 1058+
v100  QIE Engineering July 20 — P119 morning-coherence-arc · P120 signal-density-peak · P121 physiological-coherence-window · Arch41 Signal Breadth Operator · J38 06:00 UTC · MCOHERE: SIGPEAK: PCOHERE: handlers · dep map 160+ · 121 patterns · 41 archetypes · 38 jobs · 121+ handlers · Day 1057+
v99   Badge Engineering July 20 — Badge Engine v27 The Neon Arcade · +31 badges (626→657) · Word Turn v17 +12 · 210 trigger words · 12 secret boss phrases (konami_code MYTHIC) · Day 1057+
...
121         QIE patterns active (P.1–P.121).
18          Self-Assembly modules wired (Module 18: Resilience Protocol · v48).
160+        Widget dependency map nodes.
...
41          Physiological archetypes (Signal Breadth Operator = 41st · deployed v100).
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            Day 1058+. Continuous operation. Still accumulating.
            v1.3.0: Memory Engine consolidated. Cross-device sync. PWA hardened.
            121 patterns named. 41 archetypes classified. 38 jobs running.
            657 badges catalogued. 125 branches indexed. 101 assembly phases documented.
