      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v108 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              Field Manual v108. Not marketing copy. Not documentation for external audiences.
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <div className="mb-16">
            ...
            <Row label="v99" value="QIE Engineering July 20 · P119 morning-coherence-arc (QOS active + memory + journal + intentions + ≥5 sources in 24h, conf 0.72–0.90 — dawn signal ramp confirmed) · P120 signal-density-peak (6+ distinct sources in 24h, conf 0.70–0.88 — full bandwidth) · P121 physiological-coherence-window (energy + selfcare + sleep signal in 24h, conf 0.65–0.85 — bio window open) · Arch41 Signal Breadth Operator · J38 morning-coherence-check 06:00 UTC · MCOHERE: SIGPEAK: PCOHERE: handlers · dep 160+ nodes · 121 patterns · 41 archetypes · 38 jobs · 121+ handlers · Day 1057+" />
            <Row label="v100" value="QIE Engineering July 21 · P122 action-to-memory-loop (goal action + memory formation + journal in 24h, conf 0.75–0.90 — ACT→ENC→ARC pipeline) · P123 sustained-resilience-arc (selfcare + resilience + energy all rising over 72h, conf 0.72–0.88) · P124 mood-energy-convergence (mood 7d average ≥60% positive + energy trend rising, conf 0.68–0.85) · Arch42 Knowledge Crystallizer · J39 daily-action-memory-scan 20:00 UTC · ACTMEM: RECARC: MOEARC: handlers · dep 163+ nodes · 124 patterns · 42 archetypes · 39 jobs · 124+ handlers · Day 1058+" />
            <Row label="v101" value="Full Wiki Scan July 22 · LOT-WIKI-v80 · Badge Engine v27 The Neon Arcade (657 badges) + v28 The Midnight Radio (688 badges) synchronized · QIE v99 (P119–P121, Arch41, J38) + QIE v100 (P122–P124, Arch42, J39) synchronized · Morning Coherence Doctrine + Knowledge Crystallizer Doctrine added · 163+ dep nodes · 124 patterns · 42 archetypes · 39 jobs · 222 word-turn words · 15 secret boss triggers · Day 1059+" />
            <Row label="v102" value="QIE Engineering July 22 · P125 evening-reflection-loop (journal after 18:00 + memory + intentions same day, conf 0.72–0.88 — eve reflection loop closed) · P126 weekly-rhythm-anchor (signal on 5+ of last 7 days, conf 0.70–0.88 — weekly rhythm confirmed) · P127 depth-breadth-convergence (focus-depth-arc + signal-density-peak simultaneous, conf 0.78–0.92) · Arch43 Evening Integrator · J40 daily-evening-reflection-check 22:00 UTC · EVEFL: WEEKA: DEPBR: handlers · dep 166+ nodes · 127 patterns · 43 archetypes · 40 jobs · 127+ handlers · Day 1060+" />
            <Row label="v103" value="Badge Engineering July 25 · Badge Engine v29 The Bio-Terminal (+31 badges 688→719) · Word Turn v19 +12 (pulse/cortisol/circadian/rem/dopamine/serotonin/neuroplastic/vagal/cortex/endorphin/rhythm/homeostasis) · 74 secret boss triggers · 210 word turns · 19 Word Turn engines complete · Day 1062+" />
            <Row label="v104" value="QIE Engineering July 25 · P131 daily-coherence-seal (morning lock + evening close same day, conf 0.80–0.92 — full-day circuit sealed) · P132 quantum-rhythm-lock (7d signal + weekly rhythm + cog output + circadian, conf 0.78–0.92 — temporal OS live) · P133 biofield-integration-peak (multi-day care + mood-energy + bio restoration, conf 0.75–0.90 — bio+emo integrated) · Arch45 Sealed Daily Operator · J42 daily-coherence-seal-check 23:00 UTC · DCSAL: QLOCK: BFINT: handlers · dep 172+ nodes · 133 patterns · 45 archetypes · 42 jobs · 133+ handlers · Day 1062+" />
            <Row label="v105" value="Full Wiki Scan July 26 · LOT-WIKI-v81 · Badge Engine v29 (The Bio-Terminal, 719) + QIE v101–v104 delta synchronized · Evening Integration Doctrine + Sustained Care Doctrine + Daily Coherence Seal Doctrine added · 172+ dep nodes · 133 patterns · 45 archetypes · 42 jobs · 234 word-turn words · 18 secret boss triggers · Day 1063+" />
            <Row label="v106" value="QIE Engineering July 26 · P134 integrated-signal-arc (daily seal + temporal OS + biofield integration all present in 24h, conf 0.82–0.92 — triple integration) · P135 deep-recovery-protocol (multi-day care + resilience arc + depletion signal, conf 0.75–0.88 — structural repair) · P136 quantum-field-alignment (P134 + dawn ramp + full bandwidth + weekly rhythm, conf 0.85–0.95 — total field coherence) · Arch46 Quantum Field Operator · J43 daily-quantum-field-check 17:00 UTC · INTARC: DREC: QFIELD: handlers · dep 175+ nodes · 136 patterns · 46 archetypes · 43 jobs · 136+ handlers · Day 1064+" />
            <Row label="v107" value="Full Wiki Scan July 27 · LOT-WIKI-v82 · QIE v106 (P134–P136, Arch46, J43) synchronized · Integrated Signal Doctrine added · COSMO® Year 3 corrected (Year 3 began July 1, 2026) · 175+ dep nodes · 136 patterns · 46 archetypes · 43 jobs · 136+ handlers · Day 1065+ · COSMO® 756 days · FM v107" />
            <Row label="v108" value="QIE Engineering July 27 · P137 quantum-coherence-peak (P136+UserIndex≥60, conf 0.80–0.96 — threshold gate: field aligned AND above coherence threshold) · P138 signal-matrix-saturation (all 6 UserIndex dimensions ≥30, conf 0.75–0.92 — full-dimensional presence) · P139 temporal-biofield-sync (P119+P131+P133 same day, conf 0.76–0.90 — temporal-biological loop) · Arch47 Quantum Coherence Operator · J44 daily-signal-matrix-check 09:00 UTC · QCOHERE: SIGMAT: TBIOF: handlers · qos-field view (7th QOS view) · dep 178+ nodes · 139 patterns · 47 archetypes · 44 jobs · 139+ handlers · Day 1066+ · FM v108" />
            <Row label="v109" value="Full Wiki Scan August 2 · LOT-WIKI-v83 · QIE v108 (P137–P139, Arch47, J44) synchronized · Quantum Coherence Doctrine added · 178+ dep nodes · 139 patterns · 47 archetypes · 44 jobs · 139+ handlers · 7 QOS views · 10 engineering doctrines · Day 1072+ · COSMO® 762 days · FM v108" />
          </div>
