      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v100 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              Field Manual v100. Not marketing copy. Not documentation for external audiences.
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v100. Phase name: QIE Engineering July 21 — P122 action-to-memory-loop · P123 sustained-resilience-arc · P124 mood-energy-convergence · Arch42 Knowledge Crystallizer · J39 daily-action-memory-scan (20:00 UTC) · ACTMEM: RECARC: MOEARC: handlers · 163+ dep nodes · 124 patterns · 42 archetypes · 39 jobs · 124+ handlers · Day 1058+.
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <P>
            ...
            124 patterns named. 18 modules wired. 163+ dependency nodes.
            6 device nodes registered. 6 index dimensions operational.
            42 physiological archetypes classified. 39 background jobs active.
            124+ distinct log event handlers. 70 backup questions across 4 pools.
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            124 patterns named. 42 archetypes classified. 39 jobs running.
            626 badges catalogued. 125 branches indexed. 100 assembly phases documented.
