      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v91 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1042+. Continuous operation since launch.
              ...
              112+ log event handlers. 125 active branches scanned.
              564 badges catalogued. 70+ categories. 430+ hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v91. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 115 patterns active. Zero server communication. 7-day signal retention.</Li>
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v86. Phase name: QIE Engineering July 5 — P107 temporal-alignment-peak · P108 creative-output-peak · P109 full-system-coherence · Arch37 Temporal Architect · J34 daily-temporal-alignment-check (10:00 UTC) · TALIGN: CROUT: FSCOHERE: handlers · dep map 148+ · 109 patterns · 37 archetypes · 34 jobs.
            Prior phase v85: Full Wiki Scan July 5 — LOT-WIKI-v73 · RecipeWidget 3-turn context engine (recipe→water tip→farewell) · 33-entry farewell cultural database · bug fixes documented · vocabulary expanded · military purity pass · Day 1030+
            Prior phase v84: QIE Engineering July 4 — P104 vitality-cascade · P105 social-presence-arc · P106 clarity-momentum-peak · Arch35 Vitality Architect · Arch36 Social Signal Operator · J33 daily-vitality-cascade-pulse (15:00 UTC) · VITAL-CAS: SOC-ARC: CLAR-PEAK: handlers · dep map 145+ · 106 patterns · 36 archetypes · 33 jobs.
            Prior phase v83: QIE Engineering July 2 — P101 quantum-presence-arc · P102 planner-intention-sync · P103 resilience-cascade · Arch34 Quantum Presence · J32 daily-quantum-presence-check (18:00 UTC) · dep map 142+ · 103 patterns · 34 archetypes · 32 jobs.
            Prior phase v80: QIE Engineering July 1 — P95 intent-to-action-gap · P96 recovery-initiation · P97 cognitive-vitality-sync · Arch33 Dynamic Responder · J31 · IGAP: RECOV: VSYNC: handlers · dep map 136+ · 97 patterns.
            Prior phase v79: Full Wiki Scan July 1 — LOT-WIKI-v69 · COSMO® 2nd birthday · vocabulary index expanded · 94 patterns · 32 archetypes · 30 jobs · 424 badges v20 · Day 1026+
            ...
            85 iterations since continuous operation began.
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <P>
            Self-Assembly: 86 phases documented in continuous operation logs.
            Each phase named, dated, versioned, committed.
            109 patterns named. 18 modules wired. 148+ dependency nodes.
            6 device nodes registered. 6 index dimensions operational.
            37 physiological archetypes classified. 34 background jobs active.
            109+ distinct log event handlers. 70 backup questions across 4 pools.
            529 badges catalogued. 125 remote branches indexed. Render isolation doctrine complete.
...
37          Physiological archetypes (Temporal Architect = 37th · deployed v86).
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            Day 1030+. Continuous operation. Still accumulating.
            v1.3.0: Memory Engine consolidated. Cross-device sync. PWA hardened.
            109 patterns named. 37 archetypes classified. 34 jobs running.
            529 badges catalogued. 125 branches indexed. 86 assembly phases documented.
