      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v66 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              79 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 25 physiological archetypes.
              120+ dependency nodes. 18 background jobs.
              78+ log event handlers. 125 active branches scanned.
              249 badges catalogued. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v66. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 79 patterns active. Zero server communication. 7-day signal retention.</Li>
          ...
          <Row label="QIE pattern library:" value="79 patterns active" />
          <Row label="Physiological archetypes:" value="25 — Diurnal Operator (v66) · Signal Initiator (v65) · Achievement Catalyst (v64) · Convergent Operator (v62) · Integration Architect (v60) · Temporal Integrator (v58) · Signal Architect (v54b) · Coherence Holder (v45) · Intention Executor (v33) · Social Synthesizer (v26) · Clarity Architect (v26)" />
