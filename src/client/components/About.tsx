      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v70 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1021+. Continuous operation since launch.
              83 behavioral patterns active. 18 modules assembled.
              ...
              354 badges catalogued. 47 categories. 326 hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v70. Not marketing copy. Not documentation for external audiences.
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v70. Phase name: Full Wiki Scan June 25 — Badge Codex v18 Arcade Protocol (354 badges, 47 categories, 326 hidden) · CUBIQ™ documented · error.html + about-standalone.ejs deployed · vocabulary synchronized · Day 1021+.
            ...
            Prior phase v67: QIE Engineering June 21 — P.80 signal-momentum-lock. Archetype 26 Momentum Architect. Job 19 daily-signal-momentum-check 20:00 UTC. MOM: handler. Day 1017+.
            Prior phase v66: QIE Engineering June 21 — P.79 evening-coherence-close. Archetype 25 Diurnal Operator. Job 18 daily-evening-coherence-close 22:00 UTC. EVE: handler. Day 1017+.
            Prior phase v65: QIE Engineering June 19 — P.76 morning-coherence-launch · P.77 signal-vault · P.78 depletion-recovery-surge · Archetype 24 Signal Initiator · Job 17. Dep map 120+ nodes. Day 1014+.
            70 iterations since continuous operation began.
...
v70   Full Wiki Scan June 25 · Badge Codex v18 Arcade Protocol (319→354 badges · +35 · 47 categories · 326 hidden · 102 word-turn triggers · 36 time triggers — Word Turn v9 Arcade Cabinet +12 · Time v9 Power-Up Hours +4 · Calendar v8 Game Anniversaries +3 · Behavioral v8 Arcade Patterns +3 · Mastery v8 Hall of Fame +3 · Achievement RPG v6 Arcade Class +4 · Secret Boss v8 Arcade Final Boss +6) · CUBIQ™ quantum cubic session model documented (5–11 min sessions · R&D $15/mo · Usership $99/mo · Legacy $3,564/3yr · Admin $11,000/9yr) · error.html static error page (LOT style · error code · version · timestamp · links) + about-standalone.ejs (About route isolated from SPA dependency) · vocabulary synchronized · military purity pass · Day 1021+`}</CodeBlock>
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <CodeBlock>{`Day 1021+   Continuous operation.
v70         Full Wiki Scan June 25 — Badge Codex v18 Arcade Protocol (354 badges) · CUBIQ™ · error page · vocabulary synchronized — current phase.
...
28          Physiological archetypes (Vital Architect = 28th · deployed v69).
...
354         Total badges (Master Codex v18 Arcade Protocol · 47 categories · 326 hidden).
70          Self-Assembly phases documented.
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            Day 1021+. Continuous operation. Still accumulating.
