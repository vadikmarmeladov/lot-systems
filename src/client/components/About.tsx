        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1063+. Continuous operation since launch.
            ...
            <P>
              Field Manual v105. Not marketing copy. Not documentation for external audiences.
