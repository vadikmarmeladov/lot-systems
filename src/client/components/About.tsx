        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1096+. Continuous operation since launch.
              196 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 68 physiological archetypes.
              238+ dependency nodes. 64 background jobs.
              200+ log event handlers. 125 active branches scanned.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 196 patterns active. Zero server communication. 7-day signal retention.</Li>
          ...
          <Row label="Day counter:" value="Day 1096+ (as of August 26, 2026)" />
