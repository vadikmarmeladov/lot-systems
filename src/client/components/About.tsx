      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v79 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              97 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 34 physiological archetypes.
              136+ dependency nodes. 32 background jobs.
              98+ log event handlers. 125 active branches scanned.
              424 badges catalogued. 51 categories. 361+ hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v79. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 97 patterns active. Zero server communication. 7-day signal retention.</Li>
          ...
          <Row label="Background jobs:" value="32 — 00:00 UTC daily OS snapshot · 01:00 UTC daily systemic readiness check (v78 job 30 — SYSRDY: ARCH·CONF·ATP·READINESS) · 03:00 UTC daily QIE analytics · 06:00 UTC daily intention audit · 06:00 UTC Mon weekly cohort digest · 06:00 UTC Sun weekly cognitive depth check (v68 job 20 — COGN: COGNITIVE DEPTH ARC · cognitive_depth_arc event) · 04:00 UTC Wed weekly QOS digest · 07:00 UTC daily source diversity pulse · 08:00 UTC morning biofield summary · 09:00 UTC 1st monthly email sender · 09:00 UTC Sat weekly pattern health report (v76 job 27 — PHR: ACTIVE/COVERAGE%/TOP pattern) · 09:00 UTC Tue weekly badge progress scan (v64 job 16 — BADGE-SCAN: UNLOCKS:/7D · TYPES: · MOMENTUM:) · 10:00 UTC daily archetype shift monitor · 10:00 UTC daily somatic journal check (v79 job 32 — SOMA: PAIRS 2H·WINDOW) · 11:00 UTC daily morning intention launch (v65 job 17 — MCL: MORNING LAUNCH · morning_coherence_launch event) · 12:00 UTC daily vitality peak check (v69 job 21 — VITAL: CIRCADIAN VITALITY PEAK · vitality_peak event · morning mood + energy + biorhythm) · 13:00 UTC daily QOS signature pulse · 15:00 UTC Sun weekly QOS convergence audit (v62 job 15) · 16:00 UTC daily coherence index pulse · 17:00 UTC daily physiological cohort broadcast (v76 job 26 — physiological_cohort event · reads archetype/dominantModule/confidence/energyBand) · 19:00 UTC daily cross-domain pulse (v78 job 29 — CROSS: CROSS-DOMAIN MASTERY PULSE · cross_domain_mastery_pulse event) · 20:00 UTC daily signal momentum check (v67 job 19 — MOM: MOMENTUM LOCK · signal_momentum event) · 20:00 UTC Sun weekly intention completion audit · 21:00 UTC daily presence arc check (v78 job 28 — PRES: full_presence_arc event) · 22:00 UTC daily evening coherence close (v66 job 18 — EVE: EVENING CLOSE · evening_coherence_close event) · 23:00 UTC daily pattern coverage audit · 23:00 UTC daily memory synthesis check (v79 job 31 — MEM2: MEMORY 4H·WINDOW) · 05:00 UTC Thu weekly archetype stability monitor" />
          <Row label="Log event handlers:" value="98+ distinct event types rendered · military log codes · v79: MEM2: (memory_synthesis_burst: MEMORY 4H·WINDOW) · SOMA: (somatic_journal_arc: PAIRS 2H·WINDOW) · SPEC: (full_spectrum_week: CHANNELS 7D·ACTIVE) · v78: RLOCK: (daily_rhythm_lock) · CROSS: (cross_domain_mastery_pulse: MEM 7D·WORDS·BADGES·GOALS·PLANS) · SYSRDY: (systemic_readiness_peak: ARCH·CONF·ATP·READINESS) · v76: LEARN: (quantum_learning_spiral: MEM 7D·WORDS 7D·BADGES 7D) · ACCT: (accountability_arc: INTENT 7D·COHORT 7D·GOALS 7D) · PRES: (full_presence_arc: MORNING count·EVENING count) · PHR: (pattern_health_scan: ACTIVE·COVERAGE%·TOP pattern) · v75: STORY: (lot_ai_story: W{n} TONE MOOD CHK CARE INTENT) · DRCT: (archetype_directive_pulse: label+ARCH+directive) · v68: COGN: (cognitive_depth_arc: COGNITIVE DEPTH ARC·MEM 7D:·WORDS:·BADGES:) · v67: MOM: (signal_momentum: MOMENTUM LOCK·DAYS 7D:·SRC:) · v66: EVE: (evening_coherence_close: EVENING CLOSE·Arc confirmed·CAPTURE: n channels) · v65: MCL: (morning_coherence_launch: MORNING LAUNCH·intent·+min) · VAULT: (signal_vault: DEPTH·wordcount·SRC·n/3) · SURGE: (depletion_recovery_surge: state→HIGH·CARE 6H:) · v64: BADGE: (badge_unlock: symbol·name·CAT:) · BADGE-SCAN: (badge_progress_scan: UNLOCKS:/7D·TYPES:·MOMENTUM:) · v62: CRYSTAL: (signal_crystallization) · BIO-LOCK: (biorhythm_lock) · PEAK-SUMMIT: (quantum_coherence_summit) · CONV-AUDIT: (convergence_audit)" />
          <Row label="Dep map nodes:" value="136+ — INTENT [VEL] · SIG [BURST] · QIE [PAT] nodes added v45 · coherenceHolder dep node added · crystallizationArc · vitalConvergence added v39 · 8 new nodes added v52 (aiFeedback · moodAnalytics · journalReflection · energyCapacitor · integrityWidget · interfaceEvolution · worldCanvas · architectWidget) · 5 new nodes added v54b (benchmarkWidget · fourDimensionalUI · angelInvestor · demoDay · subscribeWidget) · 5 new nodes added v65 (publicProfile · plannerWidget · moodMomentum · breatheMonitor · fastingSignal) · 2 new nodes added v79 (memorySynthesisMonitor · somaticJournalDetector)" />
...
32          Physiological archetypes (Rhythm Architect = 31st · Integrated Operator = 32nd · deployed v78).
