      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v92 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              112 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 38 physiological archetypes.
              151+ dependency nodes. 35 background jobs.
              112+ log event handlers. 125 active branches scanned.
              595 badges catalogued. 75+ categories. 430+ hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v92. Not marketing copy. Not documentation for external audiences.
