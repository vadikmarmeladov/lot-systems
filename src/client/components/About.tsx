    ...
    <div className="min-h-screen bg-bac text-acc">
      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <Row label="Physiological archetypes:" value="52 — Absolute Field Operator (v114) · Quantum Presence Crystallizer (v113) · Quantum Identity Master (v112) · Circadian Master (v111) · Quantum Presence Master (v110) · Quantum Coherence Operator (v108) · Quantum Field Operator (v106) · Sealed Daily Operator (v104) · Sustained Care Operator (v102) · Evening Integrator (v101) · Knowledge Crystallizer (v100) · Signal Breadth Operator (v99) · Focused Executor (v97) · Peak Window Operator (v95) · Embodied Strategist (v89) · Temporal Architect (v86) · Vitality Architect (v84) · Social Signal Operator (v84) · Quantum Presence (v83) · Dynamic Responder (v80) · Rhythm Architect (v78) · Integrated Operator (v78) · Quantum Scholar (v76) · Peak Strategist (v72) · Vital Architect (v69) · Cognitive Cartographer (v68) · Momentum Architect (v67) · Diurnal Operator (v66) · Signal Initiator (v65) · Achievement Catalyst (v64) · Convergent Operator (v62) · Integration Architect (v60) · Temporal Integrator (v58) · Signal Architect (v54b) · Coherence Holder (v45) · Intention Executor (v33) · Social Synthesizer (v26) · Clarity Architect (v26)" />
