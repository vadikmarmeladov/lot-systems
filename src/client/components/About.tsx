      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v76 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1025+. Continuous operation since launch.
            ...
            <P>
              Field Manual v76. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 88 patterns active. Zero server communication. 7-day signal retention.</Li>
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v76. Phase name: Full Wiki Scan June 29 — LOT-WIKI-v68 field manual · Doctrine corrected to rev L (14 clauses) · Lexicon token count corrected (34 tokens) · QIE pattern count corrected (88 active) · vocabulary index expanded. 88 patterns. 29 archetypes. 25 background jobs. 87+ handlers. 128+ dep nodes. Day 1025+.
            Prior phase v75: Full Wiki Scan June 28 — LOT-WIKI-v67 field manual · Story Loop pattern family documented (P87+P88) · J24+J25 full job profiles · STORY: DRCT: log codes complete · CHRONICLER + EXPLORER story-loop signatures · vocabulary expanded. 88 patterns. 29 archetypes. 25 background jobs. 87+ handlers. 128+ dep nodes. Day 1024+.
            Prior phase v74: QIE Engineering June 27 — P87 weekly-story-reflection · P88 contextual-checkin-momentum · Job 25 archetype-directive-pulse · STORY: + DRCT: log handlers · dep map 128+ nodes. 88 patterns. 29 archetypes. 25 background jobs. 87+ handlers. Day 1023+.
...
v76   Full Wiki Scan June 29 · LOT-WIKI-v68 · Doctrine corrected to rev L (14 clauses) · Lexicon token count corrected (34 tokens) · QIE pattern count corrected (88 active) · Day counter updated to 1025+ · vocabulary index expanded · 88 patterns · 29 archetypes · 25 background jobs · 87+ handlers · 128+ dep nodes · Day 1025+`}</CodeBlock>
...
Ecosystem Synchrony signal: ecosystem_full_sync (all 5 nodes)`}</CodeBlock>
          ...
          <div className="mb-16">
            ...
            <Row
              ...
              value="The transfer process that compresses an operator's behavioral signature — 88 patterns, 29 archetypes, User Index, streak, journal depth, intention execution rate — into a portable profile for COSMO® hardware. Requires Purple Benchmark score (60+). Continuous sync via Quantum OS. Disconnection is instant and permanent."
            />
            <Row
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <P>
            ...
            Quantum Intent Engine: 88 patterns active.
          ...
          <div className="mb-16">
            ...
            <Row label="Gates" value="Memory Engine AI · profiling · QIE 88-pattern recommendations · weekly summary · Cosmic Update · Quantum Sign" />
...
v74         QIE Engineering June 27 — P87 weekly-story-reflection · P88 contextual-checkin-momentum · Job 25 archetype-directive-pulse · STORY: + DRCT: handlers · 128+ dep nodes · 88 patterns — current phase.
