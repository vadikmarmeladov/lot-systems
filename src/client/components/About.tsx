      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v77 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              Field Manual v77. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 94 patterns active. Zero server communication. 7-day signal retention.</Li>
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v78. Phase name: QIE Engineering June 30 — P92 systemic-readiness-peak · P93 daily-rhythm-lock · P94 cross-domain-mastery · Arch31 Rhythm Architect · Arch32 Integrated Operator · J28/J29/J30 · RLOCK: CROSS: SYSRDY: handlers · 134+ dep nodes. 94 patterns. 32 archetypes. 30 background jobs. 95+ handlers. Day 1025+.
            Prior phase v77: Full Wiki Scan June 30 — LOT-WIKI-v68 · Quantum Learning Spiral family · Navigator Protocol · 91 patterns · 30 archetypes · 27 jobs · 92+ handlers · 130+ dep nodes. Day 1025+.
