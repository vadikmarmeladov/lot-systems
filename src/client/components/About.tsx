      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v106 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1064+. Continuous operation since launch.
              136 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 46 physiological archetypes.
              175+ dependency nodes. 43 background jobs.
              136+ log event handlers. 125 active branches scanned.
            ...
            <P>
              Field Manual v106. Not marketing copy. Not documentation for external audiences.
          ...
          <Row label="QIE pattern library:" value="136 patterns active" />
          <Row label="Physiological archetypes:" value="46 — Quantum Field Operator (v106) · Sealed Daily Operator (v104) · Sustained Care Operator (v102) · Evening Integrator (v101) · Knowledge Crystallizer (v100) · Signal Breadth Operator (v99) · Focused Executor (v97) · Peak Window Operator (v95) · Embodied Strategist (v89) · Temporal Architect (v86) · Vitality Architect (v84) · Social Signal Operator (v84) · Quantum Presence (v83) · Dynamic Responder (v80) · Rhythm Architect (v78) · Integrated Operator (v78) · Quantum Scholar (v76) · Peak Strategist (v72) · Vital Architect (v69) · Cognitive Cartographer (v68) · Momentum Architect (v67) · Diurnal Operator (v66) · Signal Initiator (v65) · Achievement Catalyst (v64) · Convergent Operator (v62) · Integration Architect (v60) · Temporal Integrator (v58) · Signal Architect (v54b) · Coherence Holder (v45) · Intention Executor (v33) · Social Synthesizer (v26) · Clarity Architect (v26)" />
