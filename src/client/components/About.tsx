      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              Field Manual v132. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 205 patterns active. Zero server communication. 7-day signal retention.</Li>
