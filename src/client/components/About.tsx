      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v75 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              v1.3.0. Day 1023+. Continuous operation since launch.
              88 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 29 physiological archetypes.
              128+ dependency nodes. 25 background jobs.
              87+ log event handlers. 125 active branches scanned.
              389 badges catalogued. 50 categories. 326 hidden. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v75. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 81 patterns active. Zero server communication. 7-day signal retention.</Li>
          ...
          <Row label="Background jobs:" value="25 — 00:00 UTC daily OS snapshot · 03:00 UTC daily QIE analytics · 06:00 UTC daily intention audit · 06:00 UTC Mon weekly cohort digest · 06:00 UTC Sun weekly cognitive depth check (v68 job 20 — COGN: COGNITIVE DEPTH ARC · cognitive_depth_arc event) · 04:00 UTC Wed weekly QOS digest · 07:00 UTC daily source diversity pulse · 08:00 UTC morning biofield summary · 09:00 UTC 1st monthly email sender · 09:00 UTC Tue weekly badge progress scan (v64 job 16 — BADGE-SCAN: UNLOCKS:/7D · TYPES: · MOMENTUM:) · 09:00 UTC daily archetype directive pulse (v75 job 25 — DRCT: · archetype_directive_pulse event · one of 29 directives per archetype · reads current archetype from recent archetype_shift logs) · 10:00 UTC daily archetype shift monitor · 11:00 UTC daily morning intention launch (v65 job 17 — MCL: MORNING LAUNCH · morning_coherence_launch event) · 12:00 UTC daily vitality peak check (v69 job 21 — VITAL: CIRCADIAN VITALITY PEAK · vitality_peak event · morning mood + energy + biorhythm) · 13:00 UTC daily QOS signature pulse · 14:00 UTC daily QOS mode watch (v71 job 23) · 15:00 UTC Sun weekly QOS convergence audit (v62 job 15) · 16:00 UTC daily coherence index pulse · 18:00 UTC Sun weekly LOT® AI story generation (v74 job 24 — STORY: · lot_ai_story event · 7-day compression · week tone: growth/recovery/steady) · 20:00 UTC daily signal momentum check (v67 job 19 — MOM: MOMENTUM LOCK · signal_momentum event) · 20:00 UTC Sun weekly intention completion audit · 22:00 UTC daily evening coherence close (v66 job 18 — EVE: EVENING CLOSE · evening_coherence_close event) · 23:00 UTC daily pattern coverage audit · 05:00 UTC Thu weekly archetype stability monitor · Mon 09:00 UTC weekly longitudinal drift check (v71 job 22)" />
          <Row label="Log event handlers:" value="87+ distinct event types rendered · military log codes · v75: STORY: (lot_ai_story: WEEK/TONE/MOOD/CHK/CARE/INTENT rows · cockpit format · recordWeeklyStoryViewed() deferred on render · P87 feed) · DRCT: (archetype_directive_pulse: ARCH: archetype name · directive text · one of 29 per archetype) · v68: COGN: (cognitive_depth_arc: COGNITIVE DEPTH ARC·MEM 7D:·WORDS:·BADGES:·Deep trace confirmed) · v67: MOM: (signal_momentum: MOMENTUM LOCK·DAYS 7D:·SRC:) · v66: EVE: (evening_coherence_close: EVENING CLOSE·Arc confirmed·CAPTURE: n channel(s)) · v65: PRAY: (prayer_scripture: scripture) · MCL: (morning_coherence_launch: MORNING LAUNCH·intent·+min) · VAULT: (signal_vault: DEPTH·wordcount·SRC·n/3) · SURGE: (depletion_recovery_surge: state→HIGH·CARE 6H:) · v64: BADGE: (badge_unlock: symbol·name·CAT:) · BADGE-SCAN: (badge_progress_scan: UNLOCKS:/7D·TYPES:·MOMENTUM:) · v62: CRYSTAL: (signal_crystallization) · BIO-LOCK: (biorhythm_lock) · PEAK-SUMMIT: (quantum_coherence_summit) · CONV-AUDIT: (convergence_audit)" />
          <Row label="Dep map nodes:" value="128+ — INTENT [VEL] · SIG [BURST] · QIE [PAT] nodes added v45 · coherenceHolder dep node added · crystallizationArc · vitalConvergence added v39 · 8 new nodes added v52 (aiFeedback · moodAnalytics · journalReflection · energyCapacitor · integrityWidget · interfaceEvolution · worldCanvas · architectWidget) · 5 new nodes added v54b (benchmarkWidget · fourDimensionalUI · angelInvestor · demoDay · subscribeWidget) · 5 new nodes added v65 (publicProfile · plannerWidget · moodMomentum · breatheMonitor · fastingSignal) · 2 new nodes added v75 (weeklyStoryPulse · archetypeDirectivePulse)" />
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <P>
            Current phase: v75. Phase name: QIE Engineering June 29 — P87 weekly-story-reflection (lot_ai_story received + journal within 24h · conf 0.72) · P88 contextual-checkin-momentum (3+ check-ins 24h · ≥50% positive valence · conf 0.65–0.85) · J25 daily-archetype-directive-pulse (09:00 UTC · 29 directives · reads archetype_shift) · STORY: + DRCT: handlers · recordWeeklyStoryViewed() + recordContextualCheckinMomentum() helpers · 88 patterns. 29 archetypes. 25 background jobs. 87+ handlers. 128+ dep nodes. Day 1025+.
            Prior phase v74: QIE Engineering June 28 — J24 weekly-lot-ai-story (Sun 18:00 UTC · 7-day log compression per user · lot_ai_story event · weeklyStory in user.metadata · week tone: growth/recovery/steady). 25 jobs. Day 1024+.
            Prior phase v73: Full Wiki Scan June 27 — LOT-WIKI-v66 field manual · behavioral cohort profiles expanded (6 cohorts) · Word Turn Lexicon v10 complete (126 trigger words · v1–v10) · Vocabulary Index 40+ entries. 86 patterns. 29 archetypes. 23 background jobs. 85+ handlers. Day 1023+.
            Prior phase v72: QIE Engineering June 25 — P.84 longitudinal-drift (client) · P.85 adaptive-momentum-window · P.86 vitality-strategy-peak · Archetype 29 Peak Strategist · COCKPIT-RULE military pass on 5 handlers · ADAPT-MOM: VSTRAT: handlers · dep map 126+ nodes. 86 patterns. 29 archetypes. 23 background jobs. 85+ handlers. Day 1021+.
            Prior phase v71: QIE Engineering June 25 — Job 22 weekly-longitudinal-drift-check (Mon 09:00 UTC, 28d window) · Job 23 daily-qos-mode-watch (14:00 UTC) · DRIFT: OS [MODE]: handlers · 23 jobs active.
            Prior phase v70: Full Wiki Scan June 25 — Badge Codex v18 Arcade Protocol (354 badges) · CUBIQ™ documented · error.html + about-standalone.ejs deployed · vocabulary synchronized.
            Prior phase v69: QIE Engineering June 23 — P.82 circadian-vitality-peak · P.83 systemic-thinking-mode · Archetype 28 Vital Architect · Job 21 daily-vitality-peak-check 12:00 UTC. VITAL: SYSTMK: handlers. Dep map 122+ nodes. Day 1017+.
            Prior phase v68: QIE Engineering June 22 — CRITICAL FIX signal_momentum → displayableEvents. P.81 cognitive-depth-arc. Archetype 27 Cognitive Cartographer. Job 20 weekly-cognitive-depth-check Sun 06:00 UTC. COGN: handler. Day 1017+.
            75 iterations since continuous operation began.
...
v75   QIE Engineering June 29 · P87 weekly-story-reflection (lot_ai_story + journal within 24h · reflection loop closes · conf 0.72 · suggestedWidget: systemProgress) · P88 contextual-checkin-momentum (3+ check-ins 24h · ≥50% positive valence · conf 0.65–0.85 · suggestedWidget: energy) · J25 daily-archetype-directive-pulse (09:00 UTC · reads archetype_shift · one of 29 directives · archetype_directive_pulse event) · STORY: handler (lot_ai_story: WEEK/TONE/MOOD/CHK/CARE/INTENT · cockpit format) · DRCT: handler (archetype_directive_pulse: ARCH:+directive) · _storyViewedSet dedup guard · recordWeeklyStoryViewed() + recordContextualCheckinMomentum() · displayableEvents: lot_ai_story + archetype_directive_pulse · dep map 128+ nodes · 88 patterns · 29 archetypes · 25 jobs · 87+ handlers · Day 1025+
v74   QIE Engineering June 28 · J24 weekly-lot-ai-story (Sun 18:00 UTC · 7-day log compression · dominant mood + week tone: growth/recovery/steady · lot_ai_story event + user.metadata.weeklyStory) · displayableEvents: lot_ai_story · 25 background jobs · Day 1024+
...
◉       50+     Transparent     Fully transparent. Self-sustaining.`}</CodeBlock>
          ...
          <P>
            Master Codex v18 Arcade Protocol — 354 badges across 47 categories.
            326 hidden and discoverable. 28 visible and documented.
            102 word-turn triggers across 9 vocabulary sets.
            36 time-based triggers across 9 clock-moment sets.
          ...
          <P>Two active badge paths. Full arcade codex. 354 badges total. 47 categories. 326 hidden.</P>
...
Derived from: useLogs() — no new network request`}</CodeBlock>
          ...
          <P>
            Self-Assembly: 75 phases documented in continuous operation logs.
            Each phase named, dated, versioned, committed.
            88 patterns named. 18 modules wired. 128+ dependency nodes.
            5 device nodes registered. 6 index dimensions operational.
            29 physiological archetypes classified. 25 background jobs active.
            87+ distinct log event handlers. 70 backup questions across 4 pools.
            389 badges catalogued. 125 remote branches indexed. Render isolation doctrine complete.
            5 log triggers active: /qi · /qos · /assembly · /phys · /sil.
            The log is the record. The record is the system.
            The system is the operator.
          </P>
          <CodeBlock>{`Day 1025+   Continuous operation.
v75         QIE Engineering June 29 — P87 weekly-story-reflection · P88 contextual-checkin-momentum · J25 archetype-directive-pulse (09:00 UTC daily · 29 directives) · STORY: DRCT: handlers · 88 patterns · 25 jobs · 87+ handlers · 128+ dep nodes — current phase.
v74         QIE Engineering June 28 — J24 weekly-lot-ai-story (Sun 18:00 UTC · 7-day compression · lot_ai_story event · weeklyStory metadata) · 25 jobs.
...
v70         Full Wiki Scan June 25 — Badge Codex v19 Quantum Protocol (389 badges) · CUBIQ™ · error page · vocabulary synchronized.
...
29          Physiological archetypes (Peak Strategist = 29th · deployed v72).
...
Mythic      Meta-Signal · ◉·◉ · hidden.`}</CodeBlock>
          <P>
            ...
            Day 1023+. Continuous operation. Still accumulating.
            v1.3.0: Memory Engine consolidated. Cross-device sync. PWA hardened.
            83 patterns named. 28 archetypes classified. 21 jobs running.
            354 badges catalogued. 125 branches indexed. 70 assembly phases documented.
