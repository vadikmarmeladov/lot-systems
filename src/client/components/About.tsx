      ...
      <div className="max-w-5xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-56 shrink-0 sticky top-0 h-screen overflow-y-auto py-16 pr-16">
          <div className="mb-16">
            ...
            <Meta>Field Manual v68 · v1.3.0</Meta>
          </div>
        ...
        <main className="flex-1 min-w-0 px-16 lg:px-0 py-16 lg:py-16 mt-16 lg:mt-0">
          ...
          <header className="mb-24">
            ...
            <P>
              ...
              80 behavioral patterns active. 18 modules assembled.
              6 index dimensions. 6 ecosystem nodes. 26 physiological archetypes.
              120+ dependency nodes. 19 background jobs.
              79+ log event handlers. 125 active branches scanned.
              284 badges catalogued. The system does not sleep. It accumulates.
            </P>
            <P>
              Field Manual v68. Not marketing copy. Not documentation for external audiences.
          ...
          <ul className="list-none pl-16 mb-16">
            ...
            <Li>Quantum Intent Engine — client-side behavioral pattern recognition. 80 patterns active. Zero server communication. 7-day signal retention.</Li>
...
Privacy: localStorage only, auto-purged, never synced`}</CodeBlock>
          ...
          <div className="mb-16">
            ...
            <Row label="v68" value="Badge Codex v16 June 23 · 284 badges (+35 from v15 baseline of 249) across 41 categories · Word Turn v7 RPG Lexicon (+12: loot/boss/save/respawn/grind/level/quest/potion/dungeon/armor/stealth/rogue) · Time v7 Deep Signal (+4: 02:02 deep_night · 14:14 midday_signal · 05:55 liminal_hour · 03:33 sacred_triple) · Calendar v6 (+3: Apr4 dos_day · Nov11 eleven_eleven · Mar1 march_protocol) · Behavioral v6 (+3: three_week_archive 21 consecutive journal entries · dawn_runner 3 pre-06:00 check-ins in one week · weekend_warrior Perfect Day on Sat+Sun same weekend) · Mastery v6 Transcendence (+4: infinite_archive 5000 check-ins · word_sovereign 50+ word-turn types · lore_keeper all calendar EE v1-v6 · century_architect same hour ×100 consecutive days) · Secret Boss v6 The Void Layer (+3: void_master void×5 entries · founders_guard April 7 ×3 consecutive years · deep_thought exact 42-day streak) · Achievement RPG v4 Legend Arc (+6: word_merchant 500+ journal words · full_presence_week all 7 CQGS modules ×7 days · time_lord all 12 Time EE v1-v3 · multi_tongue word-turns from all 5 engines · signal_economist 30 consecutive pre-09:00 days · lore_completionist 10+ calendar EEs) · badges.ts+easter-eggs.ts updated · checkAndAwardBadges() extended · void_master localStorage counter · founders_guard April-7 year tracker · century_architect 100-day same-hour tracker · signal_economist 30-day early-morning tracker · dawn_runner weekly tracker · three_week_archive consecutive journal tracker · About.tsx Field Manual v68 · Day 1018+" />
