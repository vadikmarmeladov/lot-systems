 ...
 *
 * 90-day build: Month 1 (this file) is read-only — ledger + doctrine only.
 * COGS, supplier data, and issue-log wiring arrive Month 2/3. Do not add
 * pricing math or supplier references here until the build reaches them.
 */
...
// 23-item civilian ration load per LOT-FM-001 Section 2.
// COGS ceiling: USD 40.00 landed. Margin floor: 60%. COGS withheld from ledger.
...
export const RATION_COUNT = RATION_MANIFEST.length
