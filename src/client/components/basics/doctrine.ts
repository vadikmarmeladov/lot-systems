 ...
 * SECTION 1 — RATION MANIFEST + DOCTRINE (Month 1 data)
 * Full doctrine: docs/technical/LOT-FM-001-BASIC-RATION.md
 */
...
// COGS ceiling: USD 40.00 landed (withheld from this public ledger — see
// docs/technical/LOT-FM-001-BASIC-RATION.md Section 5 for the internal estimate).
...
export const UPGRADE_ENROLLMENT_NOTE = 'ENROLLMENT OPENS — M2 BUILD CYCLE'
