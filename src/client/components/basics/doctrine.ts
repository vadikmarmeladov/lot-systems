...
export const DOCTRINE_LINES = [
  ...
  'Issue, do not sell. The operator is ON STRENGTH, not a customer.',
  'One ration per operator per month. The ledger is the marketing.',
  'No layer between public and manifest — this list is the whole offer.',
  'COGS ceiling USD 40.00 landed. Margin floor 60%. Never breached.',
]
