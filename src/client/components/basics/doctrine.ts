...
// ─── Section 3 — UPGRADE state machine (LOT-FM-001 Month 2) ──────────────────
// USERSHIP/AI -> PENDING -> ON STRENGTH -> STEADY STATE
// STAND DOWN drops the ration, retains the AI base layer.
...
export const BASICS_STATE_LABEL: Record<BasicsState, string> = {
  NONE: 'NOT ON STRENGTH',
  PENDING: 'PENDING — ROSTER INTAKE',
