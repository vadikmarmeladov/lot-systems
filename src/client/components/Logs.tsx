      ...
      if (trigger === 'toggle-synth') {
        ...
        if (!storyLoading) {
          ...
          try {
            ...
            const period = (periodMatch?.[1].toLowerCase() as 'day' | 'week' | 'month' | 'year' | undefined) || 'recent'
    ...
    <div className="relative group">
      ...
      <div className="max-w-[700px]" ref={containerRef}>
        ...
        {(storyLoading || storyResponse) && (
          <div className="mt-8">
            <Block label={storyPeriod && storyPeriod !== 'recent' ? `📖 [${storyPeriod.toUpperCase()}]` : '📖'} blockView>
              {storyLoading && !storyResponse && (
                <div className="opacity-40 tracking-widest">...</div>
              )}
              {storyResponse && (
