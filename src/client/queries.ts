...
export const useLotMailInbox = createQuery<PublicLotMail[]>('/api/mail/inbox', {
  refetchOnWindowFocus: false,
  staleTime: 30 * 1000,
})

export const useMarkMailRead = createMutation<{ mailId: string }, void>(
  'put',
  (data) => `/api/mail/${data.mailId}/read`
)
