...
import { getHourlyZodiac, getWesternZodiac, getMoonPhase, getRokuyo, getJapaneseZodiac, toWallClockDate } from '#shared/utils/astrology'
...
export async function getLogContext(user: User): Promise<LogContext> {
  ...
  const context: LogContext = {
    ...
    astroJapaneseZodiac: getJapaneseZodiac(localDate.getFullYear()),
  }
